module github.com/masikrus/pulumi-yandex/provider
...
require (
	...
	github.com/yandex-cloud/terraform-provider-yandex v0.141.0
)
...
require (
	...
	github.com/ydb-platform/terraform-provider-ydb v0.0.24 // indirect
