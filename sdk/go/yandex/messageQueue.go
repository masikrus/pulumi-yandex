...
type MessageQueue struct {
	...
	// omitted, `ymqAccessKey` specified in provider config is used. For more information see
	...
	// `namePrefix`. For more information see
	// [documentation](https://yandex.cloud/docs/message-queue/api-ref/queue/CreateQueue).
	...
	// omitted, `ymqSecretKey` specified in provider config is used. For more information see
	// [documentation](https://yandex.cloud/docs/message-queue/quickstart).
...
// SQS tags
func (o MessageQueueOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *MessageQueue) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
