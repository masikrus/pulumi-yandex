...
func (o YdbDatabaseServerlessOutput) SleepAfter() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *YdbDatabaseServerless) pulumi.IntPtrOutput { return v.SleepAfter }).(pulumi.IntPtrOutput)
}
