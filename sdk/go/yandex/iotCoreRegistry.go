...
type IotCoreRegistry struct {
	...
	LogOptions IotCoreRegistryLogOptionsOutput `pulumi:"logOptions"`
	// The resource name.
...
type iotCoreRegistryState struct {
	...
	// Options for logging for IoT Core Registry.
	LogOptions *IotCoreRegistryLogOptions `pulumi:"logOptions"`
	// The resource name.
...
type IotCoreRegistryState struct {
	...
	// Options for logging for IoT Core Registry.
	LogOptions IotCoreRegistryLogOptionsPtrInput
	// The resource name.
...
// Options for logging for IoT Core Registry.
func (o IotCoreRegistryOutput) LogOptions() IotCoreRegistryLogOptionsOutput {
	return o.ApplyT(func(v *IotCoreRegistry) IotCoreRegistryLogOptionsOutput { return v.LogOptions }).(IotCoreRegistryLogOptionsOutput)
}
