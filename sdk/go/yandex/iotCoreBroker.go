...
type IotCoreBroker struct {
	...
	LogOptions IotCoreBrokerLogOptionsOutput `pulumi:"logOptions"`
	// The resource name.
...
type iotCoreBrokerState struct {
	...
	// Options for logging for IoT Core Broker.
	LogOptions *IotCoreBrokerLogOptions `pulumi:"logOptions"`
	// The resource name.
...
type IotCoreBrokerState struct {
	...
	// Options for logging for IoT Core Broker.
	LogOptions IotCoreBrokerLogOptionsPtrInput
	// The resource name.
...
// Options for logging for IoT Core Broker.
func (o IotCoreBrokerOutput) LogOptions() IotCoreBrokerLogOptionsOutput {
	return o.ApplyT(func(v *IotCoreBroker) IotCoreBrokerLogOptionsOutput { return v.LogOptions }).(IotCoreBrokerLogOptionsOutput)
}
