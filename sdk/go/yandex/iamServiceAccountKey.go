...
type IamServiceAccountKey struct {
	...
	OutputToLockbox IamServiceAccountKeyOutputToLockboxPtrOutput `pulumi:"outputToLockbox"`
	...
	// The private key. This is only populated when neither `pgpKey` nor `outputToLockbox` are provided.
...
type iamServiceAccountKeyState struct {
	...
	// option to create a Lockbox secret version from sensitive outputs
	OutputToLockbox *IamServiceAccountKeyOutputToLockbox `pulumi:"outputToLockbox"`
	// ID of the Lockbox secret version that contains the value of `secretKey`. This is only populated when `outputToLockbox` is supplied. This version will be destroyed when the IAM key is destroyed, or when `outputToLockbox` is removed.
...
type IamServiceAccountKeyState struct {
	...
	// option to create a Lockbox secret version from sensitive outputs
	OutputToLockbox IamServiceAccountKeyOutputToLockboxPtrInput
	// ID of the Lockbox secret version that contains the value of `secretKey`. This is only populated when `outputToLockbox` is supplied. This version will be destroyed when the IAM key is destroyed, or when `outputToLockbox` is removed.
...
// option to create a Lockbox secret version from sensitive outputs
func (o IamServiceAccountKeyOutput) OutputToLockbox() IamServiceAccountKeyOutputToLockboxPtrOutput {
	return o.ApplyT(func(v *IamServiceAccountKey) IamServiceAccountKeyOutputToLockboxPtrOutput { return v.OutputToLockbox }).(IamServiceAccountKeyOutputToLockboxPtrOutput)
}

// ID of the Lockbox secret version that contains the value of `secretKey`. This is only populated when `outputToLockbox` is supplied. This version will be destroyed when the IAM key is destroyed, or when `outputToLockbox` is removed.
func (o IamServiceAccountKeyOutput) OutputToLockboxVersionId() pulumi.StringOutput {
	return o.ApplyT(func(v *IamServiceAccountKey) pulumi.StringOutput { return v.OutputToLockboxVersionId }).(pulumi.StringOutput)
}
