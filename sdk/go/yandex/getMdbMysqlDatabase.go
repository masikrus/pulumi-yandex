...
func LookupMdbMysqlDatabaseOutput(ctx *pulumi.Context, args LookupMdbMysqlDatabaseOutputArgs, opts ...pulumi.InvokeOption) LookupMdbMysqlDatabaseResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMdbMysqlDatabaseResultOutput, error) {
			args := v.(LookupMdbMysqlDatabaseArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("yandex:index/getMdbMysqlDatabase:getMdbMysqlDatabase", args, LookupMdbMysqlDatabaseResultOutput{}, options).(LookupMdbMysqlDatabaseResultOutput), nil
