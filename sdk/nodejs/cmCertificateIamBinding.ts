...
export class CmCertificateIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CmCertificateIamBindingState, opts?: pulumi.CustomResourceOptions): CmCertificateIamBinding {
        return new CmCertificateIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'yandex:index/cmCertificateIamBinding:CmCertificateIamBinding';

    /**
     * Returns true if the given object is an instance of CmCertificateIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CmCertificateIamBinding {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CmCertificateIamBinding.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: CmCertificateIamBindingArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CmCertificateIamBindingArgs | CmCertificateIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CmCertificateIamBindingState | undefined;
            resourceInputs["certificateId"] = state ? state.certificateId : undefined;
            resourceInputs["members"] = state ? state.members : undefined;
            resourceInputs["role"] = state ? state.role : undefined;
            resourceInputs["sleepAfter"] = state ? state.sleepAfter : undefined;
        } else {
            const args = argsOrState as CmCertificateIamBindingArgs | undefined;
        ...
        super(CmCertificateIamBinding.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface CmCertificateIamBindingState {
    /**
     * The [Certificate](https://yandex.cloud/docs/certificate-manager/) ID to apply a binding to.
     */
 ...
 */
export interface CmCertificateIamBindingArgs {
    /**
     * The [Certificate](https://yandex.cloud/docs/certificate-manager/) ID to apply a binding to.
     */
    certificateId: pulumi.Input<string>;
