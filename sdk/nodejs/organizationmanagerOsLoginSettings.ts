...
export class OrganizationmanagerOsLoginSettings extends pulumi.CustomResource {
     ...
     */
    public readonly sshCertificateSettings!: pulumi.Output<outputs.OrganizationmanagerOsLoginSettingsSshCertificateSettings | undefined>;
    /**
     * Users SSH key settings.
     */
    public readonly userSshKeySettings!: pulumi.Output<outputs.OrganizationmanagerOsLoginSettingsUserSshKeySettings | undefined>;
    ...
    constructor(name: string, argsOrState?: OrganizationmanagerOsLoginSettingsArgs | OrganizationmanagerOsLoginSettingsState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["sshCertificateSettings"] = state ? state.sshCertificateSettings : undefined;
            resourceInputs["userSshKeySettings"] = state ? state.userSshKeySettings : undefined;
        } else {
            ...
            resourceInputs["sshCertificateSettings"] = args ? args.sshCertificateSettings : undefined;
            resourceInputs["userSshKeySettings"] = args ? args.userSshKeySettings : undefined;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(OrganizationmanagerOsLoginSettings.__pulumiType, name, resourceInputs, opts);
    }
}
