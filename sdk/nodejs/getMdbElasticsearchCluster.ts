...
export function getMdbElasticsearchClusterOutput(args?: GetMdbElasticsearchClusterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMdbElasticsearchClusterResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("yandex:index/getMdbElasticsearchCluster:getMdbElasticsearchCluster", {
        "clusterId": args.clusterId,
        "deletionProtection": args.deletionProtection,
        "description": args.description,
        "folderId": args.folderId,
