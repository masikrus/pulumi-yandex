...
export class CmCertificateIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CmCertificateIamMemberState, opts?: pulumi.CustomResourceOptions): CmCertificateIamMember {
        return new CmCertificateIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'yandex:index/cmCertificateIamMember:CmCertificateIamMember';

    /**
     * Returns true if the given object is an instance of CmCertificateIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CmCertificateIamMember {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CmCertificateIamMember.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: CmCertificateIamMemberArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CmCertificateIamMemberArgs | CmCertificateIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CmCertificateIamMemberState | undefined;
            resourceInputs["certificateId"] = state ? state.certificateId : undefined;
            resourceInputs["member"] = state ? state.member : undefined;
            resourceInputs["role"] = state ? state.role : undefined;
            resourceInputs["sleepAfter"] = state ? state.sleepAfter : undefined;
        } else {
            const args = argsOrState as CmCertificateIamMemberArgs | undefined;
        ...
        super(CmCertificateIamMember.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface CmCertificateIamMemberState {
    /**
     * The [Certificate](https://yandex.cloud/docs/certificate-manager/) ID to apply a binding to.
     */
 ...
 */
export interface CmCertificateIamMemberArgs {
    /**
     * The [Certificate](https://yandex.cloud/docs/certificate-manager/) ID to apply a binding to.
     */
    certificateId: pulumi.Input<string>;
