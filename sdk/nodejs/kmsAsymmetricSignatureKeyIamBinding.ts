...
export class KmsAsymmetricSignatureKeyIamBinding extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: KmsAsymmetricSignatureKeyIamBindingState, opts?: pulumi.CustomResourceOptions): KmsAsymmetricSignatureKeyIamBinding {
        return new KmsAsymmetricSignatureKeyIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'yandex:index/kmsAsymmetricSignatureKeyIamBinding:KmsAsymmetricSignatureKeyIamBinding';

    /**
     * Returns true if the given object is an instance of KmsAsymmetricSignatureKeyIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is KmsAsymmetricSignatureKeyIamBinding {
     ...
     */
    constructor(name: string, args: KmsAsymmetricSignatureKeyIamBindingArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: KmsAsymmetricSignatureKeyIamBindingArgs | KmsAsymmetricSignatureKeyIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as KmsAsymmetricSignatureKeyIamBindingState | undefined;
        ...
        super(KmsAsymmetricSignatureKeyIamBinding.__pulumiType, name, resourceInputs, opts);
    }
}
