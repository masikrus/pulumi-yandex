...
export class KmsSymmetricKeyIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: KmsSymmetricKeyIamMemberState, opts?: pulumi.CustomResourceOptions): KmsSymmetricKeyIamMember {
        return new KmsSymmetricKeyIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'yandex:index/kmsSymmetricKeyIamMember:KmsSymmetricKeyIamMember';

    /**
     * Returns true if the given object is an instance of KmsSymmetricKeyIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is KmsSymmetricKeyIamMember {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === KmsSymmetricKeyIamMember.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: KmsSymmetricKeyIamMemberArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: KmsSymmetricKeyIamMemberArgs | KmsSymmetricKeyIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as KmsSymmetricKeyIamMemberState | undefined;
            ...
            const args = argsOrState as KmsSymmetricKeyIamMemberArgs | undefined;
        ...
        super(KmsSymmetricKeyIamMember.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface KmsSymmetricKeyIamMemberState {
    /**
     * An array of identities that will be granted the privilege in the `role`. Each entry can have one of the following
     * values: * **userAccount:{user_id}**: A unique user ID that represents a specific Yandex account. *
     * **serviceAccount:{service_account_id}**: A unique service account ID. * **federatedUser:{federated_user_id}**: A unique
 ...
 */
export interface KmsSymmetricKeyIamMemberArgs {
    /**
     * An array of identities that will be granted the privilege in the `role`. Each entry can have one of the following
     * values: * **userAccount:{user_id}**: A unique user ID that represents a specific Yandex account. *
     * **serviceAccount:{service_account_id}**: A unique service account ID. * **federatedUser:{federated_user_id}**: A unique
