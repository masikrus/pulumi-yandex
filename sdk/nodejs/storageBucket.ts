...
export class StorageBucket extends pulumi.CustomResource {
     ...
     *
     * @deprecated Use `yandexStorageBucketGrant` instead.
     */
     ...
     */
    declare public readonly anonymousAccessFlags: pulumi.Output<outputs.StorageBucketAnonymousAccessFlags>;
    /**
     ...
     * @deprecated Use `yandexStorageBucketGrant` instead.
     */
    declare public readonly grants: pulumi.Output<outputs.StorageBucketGrant[]>;
    /**
     ...
     *
     * @deprecated Use `yandexStorageBucketPolicy` resource instead.
     */
     ...
     */
    declare public readonly versioning: pulumi.Output<outputs.StorageBucketVersioning>;
    /**
