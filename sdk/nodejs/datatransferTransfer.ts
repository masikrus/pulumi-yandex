...
export class DatatransferTransfer extends pulumi.CustomResource {
     ...
     */
    public readonly runtime!: pulumi.Output<outputs.DatatransferTransferRuntime>;
    /**
     ...
     */
    public readonly transformation!: pulumi.Output<outputs.DatatransferTransferTransformation | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: DatatransferTransferArgs | DatatransferTransferState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["transformation"] = state ? state.transformation : undefined;
