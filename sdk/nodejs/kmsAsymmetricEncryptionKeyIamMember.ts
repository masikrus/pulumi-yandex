...
export class KmsAsymmetricEncryptionKeyIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: KmsAsymmetricEncryptionKeyIamMemberState, opts?: pulumi.CustomResourceOptions): KmsAsymmetricEncryptionKeyIamMember {
        return new KmsAsymmetricEncryptionKeyIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'yandex:index/kmsAsymmetricEncryptionKeyIamMember:KmsAsymmetricEncryptionKeyIamMember';

    /**
     * Returns true if the given object is an instance of KmsAsymmetricEncryptionKeyIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is KmsAsymmetricEncryptionKeyIamMember {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === KmsAsymmetricEncryptionKeyIamMember.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: KmsAsymmetricEncryptionKeyIamMemberArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: KmsAsymmetricEncryptionKeyIamMemberArgs | KmsAsymmetricEncryptionKeyIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as KmsAsymmetricEncryptionKeyIamMemberState | undefined;
            ...
            const args = argsOrState as KmsAsymmetricEncryptionKeyIamMemberArgs | undefined;
        ...
        super(KmsAsymmetricEncryptionKeyIamMember.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface KmsAsymmetricEncryptionKeyIamMemberState {
    /**
     * The [Yandex Key Management Service](https://yandex.cloud/docs/kms/) Asymmetric Encryption Key ID to apply a binding to.
     */
 ...
 */
export interface KmsAsymmetricEncryptionKeyIamMemberArgs {
    /**
     * The [Yandex Key Management Service](https://yandex.cloud/docs/kms/) Asymmetric Encryption Key ID to apply a binding to.
     */
    asymmetricEncryptionKeyId: pulumi.Input<string>;
