...
export class StorageObject extends pulumi.CustomResource {
     ...
     * `objectLockConfiguration` to be enabled on a bucket.
     */
     ...
     * `objectLockRetainUntilDate`. Requires `objectLockConfiguration` to be enabled on a bucket.
     */
     ...
     * `objectLockMode`. Requires `objectLockConfiguration` to be enabled on a bucket.
     */
