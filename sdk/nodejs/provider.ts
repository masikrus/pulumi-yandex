...
export class Provider extends pulumi.ProviderResource {
     ...
     */
    declare public readonly yqEndpoint: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, args?: ProviderArgs, opts?: pulumi.ResourceOptions) {
        ...
        opts = opts || {};
        {
            resourceInputs["cloudId"] = (args?.cloudId) ?? utilities.getEnv("YANDEX_CLOUD_CLOUD_ID");
            resourceInputs["endpoint"] = (args?.endpoint) ?? utilities.getEnv("YANDEX_CLOUD_ENDPOINT");
            resourceInputs["folderId"] = (args?.folderId) ?? utilities.getEnv("YANDEX_CLOUD_FOLDER_ID");
            resourceInputs["insecure"] = pulumi.output((args?.insecure) ?? utilities.getEnvBoolean("YANDEX_CLOUD_INSECURE")).apply(JSON.stringify);
            resourceInputs["maxRetries"] = pulumi.output((args?.maxRetries) ?? utilities.getEnvNumber("YANDEX_CLOUD_MAX_RETRIES")).apply(JSON.stringify);
            resourceInputs["organizationId"] = (args?.organizationId) ?? utilities.getEnv("YANDEX_CLOUD_ORGANIZATION_ID");
            resourceInputs["plaintext"] = pulumi.output((args?.plaintext) ?? utilities.getEnvBoolean("YANDEX_CLOUD_PLAINTEXT")).apply(JSON.stringify);
            resourceInputs["profile"] = (args?.profile) ?? utilities.getEnv("YANDEX_CLOUD_PROFILE");
            resourceInputs["regionId"] = (args?.regionId) ?? utilities.getEnv("YANDEX_CLOUD_REGION_ID");
            resourceInputs["serviceAccountKeyFile"] = (args?.serviceAccountKeyFile) ?? utilities.getEnv("YANDEX_CLOUD_SERVICE_ACCOUNT_KEY_FILE");
            resourceInputs["sharedCredentialsFile"] = (args?.sharedCredentialsFile) ?? utilities.getEnv("YANDEX_CLOUD_SHARED_CREDENTIALS_FILE");
            resourceInputs["storageAccessKey"] = (args?.storageAccessKey) ?? utilities.getEnv("YANDEX_CLOUD_STORAGE_ACCESS_KEY");
            resourceInputs["storageEndpoint"] = (args?.storageEndpoint) ?? utilities.getEnv("YANDEX_CLOUD_STORAGE_ENDPOINT");
            ...
            resourceInputs["ymqAccessKey"] = (args?.ymqAccessKey) ?? utilities.getEnv("YANDEX_CLOUD_YMQ_ACCESS_KEY");
            resourceInputs["ymqEndpoint"] = (args?.ymqEndpoint) ?? utilities.getEnv("YANDEX_CLOUD_YMQ_ENDPOINT");
            ...
            resourceInputs["yqEndpoint"] = args?.yqEndpoint;
            resourceInputs["zone"] = (args?.zone) ?? utilities.getEnv("YANDEX_CLOUD_ZONE");
        }
...
export interface ProviderArgs {
     ...
     * This can also be defined by environment variable `YC_YQ_ENDPOINT`.
     */
    yqEndpoint?: pulumi.Input<string>;
    /**
     * The default [availability zone](https://yandex.cloud/docs/overview/concepts/geo-scope) to operate under, if not specified by a given resource.
     * This can also be specified using environment variable `YC_ZONE`.
     */
