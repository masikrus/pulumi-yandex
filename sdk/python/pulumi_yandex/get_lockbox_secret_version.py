...
def get_lockbox_secret_version(secret_id: Optional[builtins.str] = None,
...
def get_lockbox_secret_version_output(secret_id: Optional[pulumi.Input[builtins.str]] = None,
