...
class BackupPolicyBindingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: Compute Cloud instance ID.
...
class _BackupPolicyBindingsState:
    def __init__(__self__, *,
                 ...
                 processing: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] enabled: Flag is specifies whether the policy application is enabled. May be `false` if Processing flag is `true`.
        :param pulumi.Input[builtins.str] instance_id: Compute Cloud instance ID.
        :param pulumi.Input[builtins.str] policy_id: Backup Policy ID.
        :param pulumi.Input[builtins.bool] processing: Flag that specifies whether the policy is in the process of binding to an instance.
        """
    ...
    @property
    @pulumi.getter
    def processing(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @processing.setter
    def processing(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class BackupPolicyBindings(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a BackupPolicyBindings resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            policy_id: Optional[pulumi.Input[builtins.str]] = None,
            processing: Optional[pulumi.Input[builtins.bool]] = None) -> 'BackupPolicyBindings':
        """
    ...
    @property
    @pulumi.getter
    def processing(self) -> pulumi.Output[builtins.bool]:
        """
        Flag that specifies whether the policy is in the process of binding to an instance.
        """
        return pulumi.get(self, "processing")
