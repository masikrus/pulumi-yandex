...
def get_resourcemanager_folder(cloud_id: Optional[builtins.str] = None,
...
def get_resourcemanager_folder_output(cloud_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
