...
class CdnResourceArgs:
    def __init__(__self__, *,
                 cname: pulumi.Input[_builtins.str],
                 ...
                 shielding: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] origin_group_id: The ID of a specific origin group.
        ...
        :param pulumi.Input[_builtins.str] provider_type: CDN provider is a content delivery service provider. Possible values: "ourcdn" (default) or "gcore"
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] secondary_hostnames: List of secondary hostname strings.
        :param pulumi.Input[_builtins.str] shielding: Shielding is a Cloud CDN feature that helps reduce the load on content origins from CDN servers.
    ...
    @_builtins.property
    @pulumi.getter
    def cname(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @cname.setter
    def cname(self, value: pulumi.Input[_builtins.str]):
    ...
    @_builtins.property
    @pulumi.getter
    def shielding(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @shielding.setter
    def shielding(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "shielding", value)
...
class CdnResource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if cname is None and not opts.urn:
                raise TypeError("Missing required property 'cname'")
            ...
            __props__.__dict__["shielding"] = shielding
    ...
    @_builtins.property
    @pulumi.getter(name="originGroupId")
    def origin_group_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ID of a specific origin group.
        """
        return pulumi.get(self, "origin_group_id")
    ...
    @_builtins.property
    @pulumi.getter
    def shielding(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Shielding is a Cloud CDN feature that helps reduce the load on content origins from CDN servers.
        Specify location id to enable shielding. See https://yandex.cloud/en/docs/cdn/operations/resources/enable-shielding
        """
