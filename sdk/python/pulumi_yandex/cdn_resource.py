...
class CdnResourceArgs:
    def __init__(__self__, *,
                 ...
                 origin_group_id: Optional[pulumi.Input[builtins.int]] = None,
                 origin_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 origin_protocol: Optional[pulumi.Input[builtins.str]] = None,
                 secondary_hostnames: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.bool] active: Flag to create Resource either in active or disabled state. `True` - the content from CDN is available to clients.
        :param pulumi.Input[builtins.str] cname: CDN endpoint CNAME, must be unique among resources.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] secondary_hostnames: List of secondary hostname strings.
    ...
    def origin_group_id(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "origin_group_id")

    @origin_group_id.setter
    def origin_group_id(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def secondary_hostnames(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def secondary_hostnames(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _CdnResourceState:
    def __init__(__self__, *,
                 ...
                 origin_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 origin_protocol: Optional[pulumi.Input[builtins.str]] = None,
                 provider_cname: Optional[pulumi.Input[builtins.str]] = None,
                 secondary_hostnames: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ssl_certificate: Optional[pulumi.Input['CdnResourceSslCertificateArgs']] = None,
                 updated_at: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs which assigned to resource.
        :param pulumi.Input['CdnResourceOptionsArgs'] options: CDN Resource settings and options to tune CDN edge behavior.
        :param pulumi.Input[builtins.str] provider_cname: Provider CNAME of CDN resource, computed value for read and update operations.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] secondary_hostnames: List of secondary hostname strings.
        :param pulumi.Input['CdnResourceSslCertificateArgs'] ssl_certificate: SSL certificate of CDN resource.
        """
        if active is not None:
    ...
    def provider_cname(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provider_cname(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CdnResource(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secondary_hostnames: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            ssl_certificate: Optional[pulumi.Input[Union['CdnResourceSslCertificateArgs', 'CdnResourceSslCertificateArgsDict']]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'CdnResource':
        """
    ...
    @property
    @pulumi.getter(name="originGroupId")
    def origin_group_id(self) -> pulumi.Output[Optional[builtins.int]]:
        return pulumi.get(self, "origin_group_id")

    @property
    @pulumi.getter(name="originGroupName")
    def origin_group_name(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "origin_group_name")

    @property
    @pulumi.getter(name="originProtocol")
    def origin_protocol(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "origin_protocol")

    @property
    @pulumi.getter(name="providerCname")
    def provider_cname(self) -> pulumi.Output[builtins.str]:
        """
        Provider CNAME of CDN resource, computed value for read and update operations.
        """
        return pulumi.get(self, "provider_cname")
    ...
    @property
    @pulumi.getter(name="secondaryHostnames")
    def secondary_hostnames(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of secondary hostname strings.
        """
        return pulumi.get(self, "secondary_hostnames")
