...
class IamWorkloadIdentityFederatedCredentialArgs:
    def __init__(__self__, *,
                 external_subject_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] external_subject_id: Id of the workload identity federation which is used for authentication.
        :param pulumi.Input[builtins.str] federation_id: Id of the federated credential.
        :param pulumi.Input[builtins.str] service_account_id: Id of the service account that the federated credential belongs to.
        """
    ...
    def external_subject_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def external_subject_id(self, value: pulumi.Input[builtins.str]):
...
class _IamWorkloadIdentityFederatedCredentialState:
    def __init__(__self__, *,
                 ...
                 external_subject_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] created_at: Id of the external subject.
        :param pulumi.Input[builtins.str] external_subject_id: Id of the workload identity federation which is used for authentication.
        :param pulumi.Input[builtins.str] federation_id: Id of the federated credential.
        :param pulumi.Input[builtins.str] service_account_id: Id of the service account that the federated credential belongs to.
        """
    ...
    @property
    @pulumi.getter(name="externalSubjectId")
    def external_subject_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Id of the workload identity federation which is used for authentication.
        """
        return pulumi.get(self, "external_subject_id")
    ...
    @external_subject_id.setter
    def external_subject_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "external_subject_id", value)
...
class IamWorkloadIdentityFederatedCredential(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a IamWorkloadIdentityFederatedCredential resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            external_subject_id: Optional[pulumi.Input[builtins.str]] = None,
            federation_id: Optional[pulumi.Input[builtins.str]] = None,
            service_account_id: Optional[pulumi.Input[builtins.str]] = None) -> 'IamWorkloadIdentityFederatedCredential':
        """
    ...
    @property
    @pulumi.getter(name="externalSubjectId")
    def external_subject_id(self) -> pulumi.Output[builtins.str]:
        """
        Id of the workload identity federation which is used for authentication.
        """
        return pulumi.get(self, "external_subject_id")
