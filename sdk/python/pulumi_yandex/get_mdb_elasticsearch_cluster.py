...
def get_mdb_elasticsearch_cluster(cluster_id: Optional[builtins.str] = None,
...
def get_mdb_elasticsearch_cluster_output(cluster_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
