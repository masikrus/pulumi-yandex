...
class SwsWafProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SwsWafProfileCoreRuleSetArgs'] core_rule_set: Core rule set settings. See [Basic rule set](https://yandex.cloud/en/docs/smartwebsecurity/concepts/waf#rules-set) for
               details.
...
class SwsWafProfile(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a SwsWafProfile resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[builtins.str] cloud_id: The `Cloud ID` which resource belongs to. If it is not provided, the default provider `cloud-id` is used.
        :param pulumi.Input[Union['SwsWafProfileCoreRuleSetArgs', 'SwsWafProfileCoreRuleSetArgsDict']] core_rule_set: Core rule set settings. See [Basic rule set](https://yandex.cloud/en/docs/smartwebsecurity/concepts/waf#rules-set) for
               details.
        :param pulumi.Input[builtins.str] description: The resource description.
