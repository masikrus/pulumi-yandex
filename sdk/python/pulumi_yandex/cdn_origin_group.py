...
class CdnOriginGroupArgs:
    def __init__(__self__, *,
                 ...
                 use_next: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] use_next: If the option is active (has true value), in case the origin responds with 4XX or 5XX codes, use the next origin from
               the list.
        """
    ...
    def use_next(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @use_next.setter
    def use_next(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class CdnOriginGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            origins: Optional[pulumi.Input[Sequence[pulumi.Input[Union['CdnOriginGroupOriginArgs', 'CdnOriginGroupOriginArgsDict']]]]] = None,
            use_next: Optional[pulumi.Input[builtins.bool]] = None) -> 'CdnOriginGroup':
        """
    ...
    @property
    @pulumi.getter(name="useNext")
    def use_next(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If the option is active (has true value), in case the origin responds with 4XX or 5XX codes, use the next origin from
        the list.
        """
