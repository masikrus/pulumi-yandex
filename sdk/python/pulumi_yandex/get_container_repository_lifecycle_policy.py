...
def get_container_repository_lifecycle_policy(lifecycle_policy_id: Optional[builtins.str] = None,
...
def get_container_repository_lifecycle_policy_output(lifecycle_policy_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
