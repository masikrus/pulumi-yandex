...
class GetIamWorkloadIdentityFederatedCredentialResult:
    ...
    def external_subject_id(self) -> builtins.str:
        return pulumi.get(self, "external_subject_id")

    @property
    @pulumi.getter(name="federatedCredentialId")
    def federated_credential_id(self) -> builtins.str:
...
def get_iam_workload_identity_federated_credential(federated_credential_id: Optional[builtins.str] = None,
...
def get_iam_workload_identity_federated_credential_output(federated_credential_id: Optional[pulumi.Input[builtins.str]] = None,
