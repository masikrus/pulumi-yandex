...
class OrganizationmanagerGroupMappingItemArgs:
    def __init__(__self__, *,
                 external_group_id: pulumi.Input[builtins.str],
                 federation_id: pulumi.Input[builtins.str],
                 internal_group_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a OrganizationmanagerGroupMappingItem resource.
        :param pulumi.Input[builtins.str] external_group_id: ID of the external group
        :param pulumi.Input[builtins.str] federation_id: ID of the SAML Federation
        :param pulumi.Input[builtins.str] internal_group_id: ID of the internal group
        """
    ...
    def external_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def external_group_id(self, value: pulumi.Input[builtins.str]):
    ...
    def internal_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def internal_group_id(self, value: pulumi.Input[builtins.str]):
...
class _OrganizationmanagerGroupMappingItemState:
    def __init__(__self__, *,
                 external_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 federation_id: Optional[pulumi.Input[builtins.str]] = None,
                 internal_group_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="externalGroupId")
    def external_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ID of the external group
        """
        return pulumi.get(self, "external_group_id")
    ...
    @external_group_id.setter
    def external_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "external_group_id", value)
    ...
    @property
    @pulumi.getter(name="internalGroupId")
    def internal_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ID of the internal group
        """
        return pulumi.get(self, "internal_group_id")
    ...
    @internal_group_id.setter
    def internal_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "internal_group_id", value)
...
class OrganizationmanagerGroupMappingItem(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a OrganizationmanagerGroupMappingItem resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            external_group_id: Optional[pulumi.Input[builtins.str]] = None,
            federation_id: Optional[pulumi.Input[builtins.str]] = None,
            internal_group_id: Optional[pulumi.Input[builtins.str]] = None) -> 'OrganizationmanagerGroupMappingItem':
        """
    ...
    @property
    @pulumi.getter(name="externalGroupId")
    def external_group_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the external group
        """
        return pulumi.get(self, "external_group_id")
    ...
    @property
    @pulumi.getter(name="internalGroupId")
    def internal_group_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the internal group
        """
        return pulumi.get(self, "internal_group_id")
