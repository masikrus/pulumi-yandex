...
def get_compute_disk_placement_group(description: Optional[builtins.str] = None,
...
def get_compute_disk_placement_group_output(description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
