...
class AlbLoadBalancerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] allow_zonal_shift: Specifies whether application load balancer is available to zonal shift
        ...
        :param pulumi.Input[builtins.str] region_id: The region ID where Load Balancer is located at.
...
class _AlbLoadBalancerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs which assigned to resource.
        :param pulumi.Input[Sequence[pulumi.Input['AlbLoadBalancerListenerArgs']]] listeners: List of listeners for the Load Balancer.
        :param pulumi.Input[builtins.str] log_group_id: Cloud Logging group ID to send logs to. Leave empty to use the balancer folder default log group.
        :param pulumi.Input['AlbLoadBalancerLogOptionsArgs'] log_options: Cloud Logging settings.
        :param pulumi.Input[builtins.str] name: The resource name.
        :param pulumi.Input[builtins.str] network_id: The `VPC Network ID` of subnets which resource attached to.
        :param pulumi.Input[builtins.str] region_id: The region ID where Load Balancer is located at.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: The list of security groups applied to resource or their components.
        :param pulumi.Input[builtins.str] status: Status of the Load Balancer.
        """
...
class AlbLoadBalancer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region_id: Optional[pulumi.Input[builtins.str]] = None,
            security_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'AlbLoadBalancer':
        """
    ...
    @property
    @pulumi.getter(name="allowZonalShift")
    def allow_zonal_shift(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether application load balancer is available to zonal shift
        """
        return pulumi.get(self, "allow_zonal_shift")
