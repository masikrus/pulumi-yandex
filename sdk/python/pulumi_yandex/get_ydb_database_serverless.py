...
class GetYdbDatabaseServerlessResult:
    ...
    def document_api_endpoint(self) -> builtins.str:
...
def get_ydb_database_serverless(database_id: Optional[builtins.str] = None,
...
def get_ydb_database_serverless_output(database_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
