...
class KubernetesNodeGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_id: The ID of the Kubernetes cluster that this node group belongs to.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_unsafe_sysctls: A list of allowed unsafe `sysctl` parameters for this node group. For more details see
        ...
        :param pulumi.Input['KubernetesNodeGroupMaintenancePolicyArgs'] maintenance_policy: Maintenance policy for this Kubernetes node group. If policy is omitted, automatic revision upgrades are enabled and
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] node_labels: A set of key/value label pairs, that are assigned to all the nodes of this Kubernetes node group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] node_taints: A list of Kubernetes taints, that are applied to all the nodes of this Kubernetes node group.
        :param pulumi.Input[builtins.str] version: Version of Kubernetes that will be used for Kubernetes node group.
        """
...
class _KubernetesNodeGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['KubernetesNodeGroupDeployPolicyArgs'] deploy_policy: Deploy policy of the node group.
        :param pulumi.Input[builtins.str] description: The resource description.
        :param pulumi.Input[builtins.str] instance_group_id: ID of instance group that is used to manage this Kubernetes node group.
        :param pulumi.Input['KubernetesNodeGroupInstanceTemplateArgs'] instance_template: Template used to create compute instances in this Kubernetes node group.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs which assigned to resource.
        :param pulumi.Input['KubernetesNodeGroupMaintenancePolicyArgs'] maintenance_policy: Maintenance policy for this Kubernetes node group. If policy is omitted, automatic revision upgrades are enabled and
               could happen at any time. Revision upgrades are performed only within the same minor version, e.g. `1.29`. Minor version
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] node_taints: A list of Kubernetes taints, that are applied to all the nodes of this Kubernetes node group.
        :param pulumi.Input['KubernetesNodeGroupScalePolicyArgs'] scale_policy: Scale policy of the node group.
        :param pulumi.Input[builtins.str] status: Status of the Kubernetes node group.
        :param pulumi.Input[builtins.str] version: Version of Kubernetes that will be used for Kubernetes node group.
...
class KubernetesNodeGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs which assigned to resource.
        :param pulumi.Input[Union['KubernetesNodeGroupMaintenancePolicyArgs', 'KubernetesNodeGroupMaintenancePolicyArgsDict']] maintenance_policy: Maintenance policy for this Kubernetes node group. If policy is omitted, automatic revision upgrades are enabled and
               could happen at any time. Revision upgrades are performed only within the same minor version, e.g. `1.29`. Minor version
               upgrades (e.g. `1.29`->`1.30`) should be performed manually.
        :param pulumi.Input[builtins.str] name: The resource name.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] node_labels: A set of key/value label pairs, that are assigned to all the nodes of this Kubernetes node group.
    ...
    @property
    @pulumi.getter(name="allowedUnsafeSysctls")
    def allowed_unsafe_sysctls(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of allowed unsafe `sysctl` parameters for this node group. For more details see
        [documentation](https://kubernetes.io/docs/tasks/administer-cluster/sysctl-cluster).
        """
