...
class ServerlessEventrouterConnectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bus_id: ID of the bus that the connector belongs to
        :param pulumi.Input[builtins.bool] deletion_protection: Deletion protection
        :param pulumi.Input[builtins.str] description: Description of the connector
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Connector labels
...
class _ServerlessEventrouterConnectorState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bus_id: ID of the bus that the connector belongs to
        :param pulumi.Input[builtins.str] cloud_id: ID of the cloud that the connector resides in
        :param pulumi.Input[builtins.str] created_at: Creation timestamp
        :param pulumi.Input[builtins.bool] deletion_protection: Deletion protection
        :param pulumi.Input[builtins.str] description: Description of the connector
        :param pulumi.Input[builtins.str] folder_id: ID of the folder that the connector resides in
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Connector labels
        :param pulumi.Input[builtins.str] name: Name of the connector
        :param pulumi.Input[Sequence[pulumi.Input['ServerlessEventrouterConnectorYdArgs']]] yds: Data Stream source of the connector
        :param pulumi.Input[Sequence[pulumi.Input['ServerlessEventrouterConnectorYmqArgs']]] ymqs: Message Queue source of the connector
...
class ServerlessEventrouterConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ServerlessEventrouterConnector resource with the given unique name, props, and options.
