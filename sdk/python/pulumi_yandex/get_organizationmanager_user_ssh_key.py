...
class GetOrganizationmanagerUserSshKeyResult:
    ...
    def subject_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "subject_id")

    @property
    @pulumi.getter(name="userSshKeyId")
    def user_ssh_key_id(self) -> builtins.str:
...
def get_organizationmanager_user_ssh_key(data: Optional[builtins.str] = None,
                                         expires_at: Optional[builtins.str] = None,
                                         name: Optional[builtins.str] = None,
                                         organization_id: Optional[builtins.str] = None,
                                         subject_id: Optional[builtins.str] = None,
                                         user_ssh_key_id: Optional[builtins.str] = None,
...
def get_organizationmanager_user_ssh_key_output(data: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                expires_at: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                organization_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                subject_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                user_ssh_key_id: Optional[pulumi.Input[builtins.str]] = None,
