...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 plaintext: Optional[pulumi.Input[builtins.bool]] = None,
                 profile: Optional[pulumi.Input[builtins.str]] = None,
                 region_id: Optional[pulumi.Input[builtins.str]] = None,
                 service_account_key_file: Optional[pulumi.Input[builtins.str]] = None,
                 shared_credentials_file: Optional[pulumi.Input[builtins.str]] = None,
                 storage_access_key: Optional[pulumi.Input[builtins.str]] = None,
                 storage_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 storage_secret_key: Optional[pulumi.Input[builtins.str]] = None,
                 token: Optional[pulumi.Input[builtins.str]] = None,
                 ymq_access_key: Optional[pulumi.Input[builtins.str]] = None,
                 ymq_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 ymq_secret_key: Optional[pulumi.Input[builtins.str]] = None,
                 zone: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Provider resource.
        :param pulumi.Input[builtins.str] cloud_id: The ID of the [Cloud](https://yandex.cloud/docs/resource-manager/concepts/resources-hierarchy#cloud) to apply any
               resources to. This can also be specified using environment variable `YC_CLOUD_ID`.
        :param pulumi.Input[builtins.str] endpoint: The endpoint for API calls, default value is **api.cloud.yandex.net:443**. This can also be defined by environment
               variable `YC_ENDPOINT`.
        :param pulumi.Input[builtins.str] folder_id: The ID of the [Folder](https://yandex.cloud/docs/resource-manager/concepts/resources-hierarchy#folder) to operate under,
        ...
        :param pulumi.Input[builtins.int] max_retries: This is the maximum number of times an API call is retried, in the case where requests are being throttled or
               experiencing transient failures. The delay between the subsequent API calls increases exponentially.
        :param pulumi.Input[builtins.str] organization_id: The ID of the [Cloud Organization](https://yandex.cloud/docs/organization/quickstart) to operate under.
        :param pulumi.Input[builtins.bool] plaintext: Disable use of TLS. Default value is `false`.
        :param pulumi.Input[builtins.str] profile: Profile name to use in the shared credentials file. Default value is `default`.
        :param pulumi.Input[builtins.str] region_id: [The region](https://yandex.cloud/docs/overview/concepts/region) where operations will take place. For example
               `ru-central1`.
        :param pulumi.Input[builtins.str] service_account_key_file: Contains either a path to or the contents of the [Service Account
        ...
        :param pulumi.Input[builtins.str] shared_credentials_file: Shared credentials file path. Supported keys: `storage_access_key` and `storage_secret_key`. > The `storage_access_key`
        ...
        :param pulumi.Input[builtins.str] storage_access_key: Yandex Cloud Object Storage access key, which is used when a storage data/resource doesn't have an access key explicitly
               specified. This can also be specified using environment variable `YC_STORAGE_ACCESS_KEY`.
        :param pulumi.Input[builtins.str] storage_endpoint: Yandex Cloud [Object Storage Endpoint](https://yandex.cloud/docs/storage/s3/#request-url), which is used to connect to
               `S3 API`. Default value is **storage.yandexcloud.net**.
        :param pulumi.Input[builtins.str] storage_secret_key: Yandex Cloud Object Storage secret key, which is used when a storage data/resource doesn't have a secret key explicitly
               specified. This can also be specified using environment variable `YC_STORAGE_SECRET_KEY`.
        :param pulumi.Input[builtins.str] token: Security token or IAM token used for authentication in Yandex Cloud. Check
        ...
        :param pulumi.Input[builtins.str] ymq_access_key: Yandex Cloud Message Queue service access key, which is used when a YMQ queue resource doesn't have an access key
               explicitly specified. This can also be specified using environment variable `YC_MESSAGE_QUEUE_ACCESS_KEY`.
        :param pulumi.Input[builtins.str] ymq_endpoint: Yandex Cloud Message Queue service endpoint. Default value is **message-queue.api.cloud.yandex.net**.
        :param pulumi.Input[builtins.str] ymq_secret_key: Yandex Cloud Message Queue service secret key, which is used when a YMQ queue resource doesn't have a secret key
    ...
    @property
    @pulumi.getter
    def plaintext(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @plaintext.setter
    def plaintext(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def service_account_key_file(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def service_account_key_file(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_account_key_file", value)

    @property
    @pulumi.getter(name="sharedCredentialsFile")
    def shared_credentials_file(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def shared_credentials_file(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def storage_secret_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def storage_secret_key(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ymq_access_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ymq_access_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ymq_access_key", value)

    @property
    @pulumi.getter(name="ymqEndpoint")
    def ymq_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ymq_endpoint.setter
    def ymq_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ymq_endpoint", value)

    @property
    @pulumi.getter(name="ymqSecretKey")
    def ymq_secret_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ymq_secret_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Provider(pulumi.ProviderResource):
    ...
    @property
    @pulumi.getter(name="regionId")
    def region_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        [The region](https://yandex.cloud/docs/overview/concepts/region) where operations will take place. For example
        `ru-central1`.
        """
    ...
    @property
    @pulumi.getter(name="serviceAccountKeyFile")
    def service_account_key_file(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Contains either a path to or the contents of the [Service Account
        file](https://yandex.cloud/docs/iam/concepts/authorization/key) in JSON format. This can also be specified using
        environment variable `YC_SERVICE_ACCOUNT_KEY_FILE`. You can read how to create service account key file
    ...
    @property
    @pulumi.getter(name="sharedCredentialsFile")
    def shared_credentials_file(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Shared credentials file path. Supported keys: `storage_access_key` and `storage_secret_key`. > The `storage_access_key`
        and `storage_secret_key` attributes from the shared credentials file are used only when the provider and a storage
        data/resource do not have an access/secret keys explicitly specified.
    ...
    @property
    @pulumi.getter(name="storageSecretKey")
    def storage_secret_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Yandex Cloud Object Storage secret key, which is used when a storage data/resource doesn't have a secret key explicitly
        specified. This can also be specified using environment variable `YC_STORAGE_SECRET_KEY`.
        """
    ...
    @property
    @pulumi.getter(name="ymqAccessKey")
    def ymq_access_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Yandex Cloud Message Queue service access key, which is used when a YMQ queue resource doesn't have an access key
        explicitly specified. This can also be specified using environment variable `YC_MESSAGE_QUEUE_ACCESS_KEY`.
        """
    ...
    @property
    @pulumi.getter(name="ymqEndpoint")
    def ymq_endpoint(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Yandex Cloud Message Queue service endpoint. Default value is **message-queue.api.cloud.yandex.net**.
        """
        return pulumi.get(self, "ymq_endpoint")
    ...
    @property
    @pulumi.getter(name="ymqSecretKey")
    def ymq_secret_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Yandex Cloud Message Queue service secret key, which is used when a YMQ queue resource doesn't have a secret key
        explicitly specified. This can also be specified using environment variable `YC_MESSAGE_QUEUE_SECRET_KEY`.
        """
