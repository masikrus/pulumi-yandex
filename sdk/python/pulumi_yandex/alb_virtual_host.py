...
class AlbVirtualHostArgs:
    def __init__(__self__, *,
                 http_router_id: pulumi.Input[builtins.str],
                 authorities: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] http_router_id: The ID of the HTTP router to which the virtual host belongs.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] authorities: A list of domains (host/authority header) that will be matched to this virtual host. Wildcard hosts are supported in the
               form of '*.foo.com' or '*-bar.foo.com'. If not specified, all domains will be matched.
        :param pulumi.Input[Sequence[pulumi.Input['AlbVirtualHostModifyRequestHeaderArgs']]] modify_request_headers: Apply the following modifications to the Request/Response header. > Only one type of actions `append` or `replace` or
               `remove` should be specified.
        :param pulumi.Input[Sequence[pulumi.Input['AlbVirtualHostModifyResponseHeaderArgs']]] modify_response_headers: Apply the following modifications to the Request/Response header. > Only one type of actions `append` or `replace` or
               `remove` should be specified.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AlbVirtualHostRouteArgs']]] routes: A Route resource. Routes are matched *in-order*. Be careful when adding them to the end. For instance, having http '/'
    ...
    def http_router_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def http_router_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "http_router_id", value)

    @property
    @pulumi.getter
    def authorities(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @authorities.setter
    def authorities(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _AlbVirtualHostState:
    def __init__(__self__, *,
                 authorities: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 http_router_id: Optional[pulumi.Input[builtins.str]] = None,
                 modify_request_headers: Optional[pulumi.Input[Sequence[pulumi.Input['AlbVirtualHostModifyRequestHeaderArgs']]]] = None,
                 modify_response_headers: Optional[pulumi.Input[Sequence[pulumi.Input['AlbVirtualHostModifyResponseHeaderArgs']]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 rate_limit: Optional[pulumi.Input['AlbVirtualHostRateLimitArgs']] = None,
    ...
    @property
    @pulumi.getter(name="httpRouterId")
    def http_router_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the HTTP router to which the virtual host belongs.
        """
        return pulumi.get(self, "http_router_id")
    ...
    @http_router_id.setter
    def http_router_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "http_router_id", value)
...
class AlbVirtualHost(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] authorities: A list of domains (host/authority header) that will be matched to this virtual host. Wildcard hosts are supported in the
               form of '*.foo.com' or '*-bar.foo.com'. If not specified, all domains will be matched.
        :param pulumi.Input[builtins.str] http_router_id: The ID of the HTTP router to which the virtual host belongs.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AlbVirtualHostModifyRequestHeaderArgs', 'AlbVirtualHostModifyRequestHeaderArgsDict']]]] modify_request_headers: Apply the following modifications to the Request/Response header. > Only one type of actions `append` or `replace` or
               `remove` should be specified.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AlbVirtualHostModifyResponseHeaderArgs', 'AlbVirtualHostModifyResponseHeaderArgsDict']]]] modify_response_headers: Apply the following modifications to the Request/Response header. > Only one type of actions `append` or `replace` or
               `remove` should be specified.
        :param pulumi.Input[builtins.str] name: The resource name.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['AlbVirtualHostRouteArgs', 'AlbVirtualHostRouteArgsDict']]]] routes: A Route resource. Routes are matched *in-order*. Be careful when adding them to the end. For instance, having http '/'
               match first makes all other routes unused. > Exactly one type of routes `http_route` or `grpc_route` should be
               specified.
        """
        ...
    ...
    @property
    @pulumi.getter
    def authorities(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of domains (host/authority header) that will be matched to this virtual host. Wildcard hosts are supported in the
        form of '*.foo.com' or '*-bar.foo.com'. If not specified, all domains will be matched.
        """
    ...
    @property
    @pulumi.getter(name="httpRouterId")
    def http_router_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the HTTP router to which the virtual host belongs.
        """
        return pulumi.get(self, "http_router_id")
