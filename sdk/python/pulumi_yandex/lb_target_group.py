...
class LbTargetGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] region_id: ID of the availability zone where the target group resides. If omitted, default region is being used.
...
class LbTargetGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a LbTargetGroup resource with the given unique name, props, and options.
