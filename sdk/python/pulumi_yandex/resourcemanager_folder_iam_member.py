...
class ResourcemanagerFolderIamMemberArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] folder_id: The ID of the folder to attach a policy to.
...
@pulumi.type_token("yandex:index/resourcemanagerFolderIamMember:ResourcemanagerFolderIamMember")
class ResourcemanagerFolderIamMember(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            member: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None,
            sleep_after: Optional[pulumi.Input[builtins.int]] = None) -> 'ResourcemanagerFolderIamMember':
        """
