...
class ComputeImageArgs:
    def __init__(__self__, *,
                 ...
                 product_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 source_disk: Optional[pulumi.Input[builtins.str]] = None,
                 source_family: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] family: The name of the image family to which this image belongs.
        ...
        :param pulumi.Input['ComputeImageHardwareGenerationArgs'] hardware_generation: Hardware generation and its features, which will be applied to the instance when this image is used for creating a boot
        ...
        :param pulumi.Input[builtins.int] min_disk_size: Minimum size in GB of the disk that will be created from this image.
        :param pulumi.Input[builtins.str] name: The resource name.
        :param pulumi.Input[builtins.str] os_type: Operating system type that is contained in the image. Possible values: `LINUX`, `WINDOWS`.
        :param pulumi.Input[builtins.bool] pooled: Optimize the image to create a disk.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] product_ids: License IDs that indicate which licenses are attached to this image.
        :param pulumi.Input[builtins.str] source_disk: The ID of a disk to use as the source of the image. Changing this ID forces a new resource to be created.
        :param pulumi.Input[builtins.str] source_family: The name of the family to use as the source of the new image. The ID of the latest image is taken from the
               `standard-images` folder. Changing the family forces a new resource to be created.
        :param pulumi.Input[builtins.str] source_image: The ID of an existing image to use as the source of the image. Changing this ID forces a new resource to be created.
        :param pulumi.Input[builtins.str] source_snapshot: The ID of a snapshot to use as the source of the image. Changing this ID forces a new resource to be created.
        :param pulumi.Input[builtins.str] source_url: The URL to use as the source of the image. Changing this URL forces a new resource to be created.
        """
    ...
    def product_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @product_ids.setter
    def product_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def source_family(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_family(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ComputeImageState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] pooled: Optimize the image to create a disk.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] product_ids: License IDs that indicate which licenses are attached to this image.
        :param pulumi.Input[builtins.int] size: The size of the image, specified in GB.
        :param pulumi.Input[builtins.str] source_disk: The ID of a disk to use as the source of the image. Changing this ID forces a new resource to be created.
        :param pulumi.Input[builtins.str] source_family: The name of the family to use as the source of the new image. The ID of the latest image is taken from the
               `standard-images` folder. Changing the family forces a new resource to be created.
        :param pulumi.Input[builtins.str] source_image: The ID of an existing image to use as the source of the image. Changing this ID forces a new resource to be created.
        :param pulumi.Input[builtins.str] source_snapshot: The ID of a snapshot to use as the source of the image. Changing this ID forces a new resource to be created.
        :param pulumi.Input[builtins.str] source_url: The URL to use as the source of the image. Changing this URL forces a new resource to be created.
        :param pulumi.Input[builtins.str] status: The status of the image.
        """
...
class ComputeImage(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] family: The name of the image family to which this image belongs.
        :param pulumi.Input[builtins.str] folder_id: The folder identifier that resource belongs to. If it is not provided, the default provider `folder-id` is used.
        :param pulumi.Input[Union['ComputeImageHardwareGenerationArgs', 'ComputeImageHardwareGenerationArgsDict']] hardware_generation: Hardware generation and its features, which will be applied to the instance when this image is used for creating a boot
               disk. Provide this property if you wish to override this value, which otherwise is inherited from the source.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs which assigned to resource.
        :param pulumi.Input[builtins.int] min_disk_size: Minimum size in GB of the disk that will be created from this image.
        :param pulumi.Input[builtins.str] name: The resource name.
    ...
    def get(resource_name: str,
            ...
            source_snapshot: Optional[pulumi.Input[builtins.str]] = None,
            source_url: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'ComputeImage':
        """
    ...
    @property
    @pulumi.getter
    def pooled(self) -> pulumi.Output[builtins.bool]:
        """
        Optimize the image to create a disk.
        """
        return pulumi.get(self, "pooled")
    ...
    @property
    @pulumi.getter(name="productIds")
    def product_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        License IDs that indicate which licenses are attached to this image.
        """
        return pulumi.get(self, "product_ids")
    ...
    @property
    @pulumi.getter(name="sourceFamily")
    def source_family(self) -> pulumi.Output[builtins.str]:
        """
        The name of the family to use as the source of the new image. The ID of the latest image is taken from the
        `standard-images` folder. Changing the family forces a new resource to be created.
        """
    ...
    @property
    @pulumi.getter(name="sourceSnapshot")
    def source_snapshot(self) -> pulumi.Output[builtins.str]:
        """
        The ID of a snapshot to use as the source of the image. Changing this ID forces a new resource to be created.
        """
        return pulumi.get(self, "source_snapshot")
