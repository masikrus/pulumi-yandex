...
class OrganizationmanagerSamlFederationUserAccountArgs:
    def __init__(__self__, *,
                 ...
                 name_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a OrganizationmanagerSamlFederationUserAccount resource.
        :param pulumi.Input[builtins.str] federation_id: ID of a SAML Federation.
        :param pulumi.Input[builtins.str] name_id: Name ID of the SAML federated user.
        """
    ...
    def name_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @name_id.setter
    def name_id(self, value: pulumi.Input[builtins.str]):
...
class _OrganizationmanagerSamlFederationUserAccountState:
    def __init__(__self__, *,
                 ...
                 name_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="nameId")
    def name_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name ID of the SAML federated user.
        """
        return pulumi.get(self, "name_id")
    ...
    @name_id.setter
    def name_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "name_id", value)
...
class OrganizationmanagerSamlFederationUserAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a OrganizationmanagerSamlFederationUserAccount resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            federation_id: Optional[pulumi.Input[builtins.str]] = None,
            name_id: Optional[pulumi.Input[builtins.str]] = None) -> 'OrganizationmanagerSamlFederationUserAccount':
        """
    ...
    @property
    @pulumi.getter(name="nameId")
    def name_id(self) -> pulumi.Output[builtins.str]:
        """
        Name ID of the SAML federated user.
        """
        return pulumi.get(self, "name_id")
