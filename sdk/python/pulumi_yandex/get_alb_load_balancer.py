...
class GetAlbLoadBalancerResult:
    ...
    """
    def __init__(__self__, allocation_policies=None, allow_zonal_shift=None, created_at=None, description=None, folder_id=None, id=None, labels=None, listeners=None, load_balancer_id=None, log_group_id=None, log_options=None, name=None, network_id=None, region_id=None, security_group_ids=None, status=None):
    ...
    def allow_zonal_shift(self) -> builtins.bool:
...
def get_alb_load_balancer(load_balancer_id: Optional[builtins.str] = None,
...
def get_alb_load_balancer_output(load_balancer_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
