...
class MdbMysqlClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] version: Version of the MySQL cluster. (allowed versions are: 5.7, 8.0, 8.4).
        :param pulumi.Input['MdbMysqlClusterAccessArgs'] access: Access policy to the MySQL cluster.
        :param pulumi.Input[_builtins.bool] allow_regeneration_host: Deprecated field. You can safely remove this option. There is no need to recreate host if assign_public_ip is changed.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] mysql_config: MySQL cluster configuration. For detailed information specific to your MySQL version, please refer to the [API proto specifications](https://github.com/yandex-cloud/cloudapi/tree/master/yandex/cloud/mdb/mysql/v1/config).
