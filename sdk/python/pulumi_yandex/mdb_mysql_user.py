...
class MdbMysqlUserArgs:
    def __init__(__self__, *,
                 ...
                 generate_password: Optional[pulumi.Input[builtins.bool]] = None,
                 global_permissions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] cluster_id: The ID of the MySQL cluster.
        :param pulumi.Input[builtins.str] authentication_plugin: Authentication plugin. Allowed values: `MYSQL_NATIVE_PASSWORD`, `CACHING_SHA2_PASSWORD`, `SHA256_PASSWORD` (for version
               5.7 `MYSQL_NATIVE_PASSWORD`, `SHA256_PASSWORD`)
        :param pulumi.Input['MdbMysqlUserConnectionLimitsArgs'] connection_limits: User's connection limits. If the attribute is not specified there will be no changes. Default value is `-1`. When these
               parameters are set to `-1`, backend default values will be actually used.
        :param pulumi.Input[builtins.bool] generate_password: Generate password using Connection Manager. Allowed values: `true` or `false`. It's used only during user creation and
               is ignored during updating. > **Must specify either password or generate_password**.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] global_permissions: List user's global permissions. Allowed permissions: `REPLICATION_CLIENT`, `REPLICATION_SLAVE`, `PROCESS` for clear list
    ...
    def generate_password(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def generate_password(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "generate_password", value)

    @property
    @pulumi.getter(name="globalPermissions")
    def global_permissions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def global_permissions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _MdbMysqlUserState:
    def __init__(__self__, *,
                 ...
                 connection_limits: Optional[pulumi.Input['MdbMysqlUserConnectionLimitsArgs']] = None,
                 connection_manager: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 generate_password: Optional[pulumi.Input[builtins.bool]] = None,
                 global_permissions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['MdbMysqlUserConnectionLimitsArgs'] connection_limits: User's connection limits. If the attribute is not specified there will be no changes. Default value is `-1`. When these
               parameters are set to `-1`, backend default values will be actually used.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] connection_manager: Connection Manager connection configuration. Filled in by the server automatically.
        :param pulumi.Input[builtins.bool] generate_password: Generate password using Connection Manager. Allowed values: `true` or `false`. It's used only during user creation and
               is ignored during updating. > **Must specify either password or generate_password**.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] global_permissions: List user's global permissions. Allowed permissions: `REPLICATION_CLIENT`, `REPLICATION_SLAVE`, `PROCESS` for clear list
               use empty list. If the attribute is not specified there will be no changes.
    ...
    def connection_manager(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def connection_manager(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class MdbMysqlUser(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a MdbMysqlUser resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[builtins.str] authentication_plugin: Authentication plugin. Allowed values: `MYSQL_NATIVE_PASSWORD`, `CACHING_SHA2_PASSWORD`, `SHA256_PASSWORD` (for version
               5.7 `MYSQL_NATIVE_PASSWORD`, `SHA256_PASSWORD`)
        :param pulumi.Input[builtins.str] cluster_id: The ID of the MySQL cluster.
        :param pulumi.Input[Union['MdbMysqlUserConnectionLimitsArgs', 'MdbMysqlUserConnectionLimitsArgsDict']] connection_limits: User's connection limits. If the attribute is not specified there will be no changes. Default value is `-1`. When these
               parameters are set to `-1`, backend default values will be actually used.
        :param pulumi.Input[builtins.bool] generate_password: Generate password using Connection Manager. Allowed values: `true` or `false`. It's used only during user creation and
               is ignored during updating. > **Must specify either password or generate_password**.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] global_permissions: List user's global permissions. Allowed permissions: `REPLICATION_CLIENT`, `REPLICATION_SLAVE`, `PROCESS` for clear list
    ...
    @property
    @pulumi.getter(name="authenticationPlugin")
    def authentication_plugin(self) -> pulumi.Output[builtins.str]:
        """
        Authentication plugin. Allowed values: `MYSQL_NATIVE_PASSWORD`, `CACHING_SHA2_PASSWORD`, `SHA256_PASSWORD` (for version
        5.7 `MYSQL_NATIVE_PASSWORD`, `SHA256_PASSWORD`)
        """
    ...
    @property
    @pulumi.getter(name="connectionManager")
    def connection_manager(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        Connection Manager connection configuration. Filled in by the server automatically.
        """
        return pulumi.get(self, "connection_manager")
    ...
    @property
    @pulumi.getter(name="generatePassword")
    def generate_password(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Generate password using Connection Manager. Allowed values: `true` or `false`. It's used only during user creation and
        is ignored during updating. > **Must specify either password or generate_password**.
        """
    ...
    @property
    @pulumi.getter(name="globalPermissions")
    def global_permissions(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List user's global permissions. Allowed permissions: `REPLICATION_CLIENT`, `REPLICATION_SLAVE`, `PROCESS` for clear list
        use empty list. If the attribute is not specified there will be no changes.
        """
