...
class GetKmsAsymmetricSignatureKeyResult:
    ...
    def asymmetric_signature_key_id(self) -> builtins.str:
...
def get_kms_asymmetric_signature_key(asymmetric_signature_key_id: Optional[builtins.str] = None,
...
def get_kms_asymmetric_signature_key_output(asymmetric_signature_key_id: Optional[pulumi.Input[builtins.str]] = None,
