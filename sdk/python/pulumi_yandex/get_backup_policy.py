...
class GetBackupPolicyResult:
    ...
    def fast_backup_enabled(self) -> builtins.bool:
    ...
    def multi_volume_snapshotting_enabled(self) -> builtins.bool:
    ...
    def performance_window_enabled(self) -> builtins.bool:
    ...
    def preserve_file_security_settings(self) -> builtins.bool:
        return pulumi.get(self, "preserve_file_security_settings")

    @property
    @pulumi.getter(name="quiesceSnapshottingEnabled")
    def quiesce_snapshotting_enabled(self) -> builtins.bool:
    ...
    def silent_mode_enabled(self) -> builtins.bool:
        return pulumi.get(self, "silent_mode_enabled")

    @property
    @pulumi.getter(name="splittingBytes")
    def splitting_bytes(self) -> builtins.str:
    ...
    def vss_provider(self) -> builtins.str:
...
def get_backup_policy(name: Optional[builtins.str] = None,
...
def get_backup_policy_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
