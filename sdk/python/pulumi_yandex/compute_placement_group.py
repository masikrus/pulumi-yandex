...
class ComputePlacementGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] placement_strategy_partitions: A number of partitions in the placement strategy with partitions policy of the Placement Group (conflicts with placement_strategy_spread).
        :param pulumi.Input[_builtins.bool] placement_strategy_spread: A placement strategy with spread policy of the Placement Group. Should be true or unset (conflicts with placement_strategy_partitions).
        """
