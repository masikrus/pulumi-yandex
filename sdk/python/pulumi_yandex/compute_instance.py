...
class ComputeInstanceArgs:
    def __init__(__self__, *,
                 ...
                 allow_recreate: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 gpu_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
                 hostname: Optional[pulumi.Input[builtins.str]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 local_disks: Optional[pulumi.Input[Sequence[pulumi.Input['ComputeInstanceLocalDiskArgs']]]] = None,
                 maintenance_grace_period: Optional[pulumi.Input[builtins.str]] = None,
                 maintenance_policy: Optional[pulumi.Input[builtins.str]] = None,
                 metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 metadata_options: Optional[pulumi.Input['ComputeInstanceMetadataOptionsArgs']] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 network_acceleration_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] gpu_cluster_id: ID of the GPU cluster to attach this instance to.
        :param pulumi.Input[builtins.str] hostname: Host name for the instance. This field is used to generate the instance `fqdn` value. The host name must be unique
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ComputeInstanceLocalDiskArgs']]] local_disks: List of local disks that are attached to the instance. > Local disks are not available for all users by default.
        :param pulumi.Input[builtins.str] maintenance_grace_period: Time between notification via metadata service and maintenance. E.g., `60s`.
        :param pulumi.Input[builtins.str] maintenance_policy: Behavior on maintenance events. Can be: `unspecified`, `migrate`, `restart`. The default is `unspecified`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: Metadata key/value pairs to make available from within the instance.
        ...
        :param pulumi.Input[builtins.str] network_acceleration_type: Type of network acceleration. Can be `standard` or `software_accelerated`. The default is `standard`.
        :param pulumi.Input['ComputeInstancePlacementPolicyArgs'] placement_policy: The placement policy configuration.
        :param pulumi.Input[builtins.str] platform_id: The type of virtual machine to create.
        :param pulumi.Input['ComputeInstanceSchedulingPolicyArgs'] scheduling_policy: Scheduling policy configuration.
        :param pulumi.Input[Sequence[pulumi.Input['ComputeInstanceSecondaryDiskArgs']]] secondary_disks: A set of disks to attach to the instance. The structure is documented below. > The `allow_stopping_for_update` property
    ...
    def allow_recreate(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "allow_recreate")

    @allow_recreate.setter
    def allow_recreate(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def gpu_cluster_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def gpu_cluster_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def maintenance_grace_period(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def maintenance_grace_period(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "maintenance_grace_period", value)

    @property
    @pulumi.getter(name="maintenancePolicy")
    def maintenance_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def maintenance_policy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def network_acceleration_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def network_acceleration_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ComputeInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ComputeInstanceFilesystemArgs']]] filesystems: List of filesystems that are attached to the instance.
        :param pulumi.Input[builtins.str] folder_id: The folder identifier that resource belongs to. If it is not provided, the default provider `folder-id` is used.
        :param pulumi.Input[builtins.str] fqdn: The fully qualified DNS name of this instance.
        :param pulumi.Input[builtins.str] gpu_cluster_id: ID of the GPU cluster to attach this instance to.
        :param pulumi.Input[builtins.str] hostname: Host name for the instance. This field is used to generate the instance `fqdn` value. The host name must be unique
               within the network and region. If not specified, the host name will be equal to `id` of the instance and `fqdn` will be
               `<id>.auto.internal`. Otherwise FQDN will be `<hostname>.<region_id>.internal`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ComputeInstanceSecondaryDiskArgs']]] secondary_disks: A set of disks to attach to the instance. The structure is documented below. > The `allow_stopping_for_update` property
               must be set to `true` in order to update this structure.
        :param pulumi.Input[builtins.str] service_account_id: [Service account](https://yandex.cloud/docs/iam/concepts/users/service-accounts) which linked to the resource.
        :param pulumi.Input[builtins.str] status: The status of this instance.
        :param pulumi.Input[builtins.str] zone: The [availability zone](https://yandex.cloud/docs/overview/concepts/geo-scope) where resource is located. If it is not
               provided, the default provider zone will be used.
        """
        if allow_recreate is not None:
...
class ComputeInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] hostname: Host name for the instance. This field is used to generate the instance `fqdn` value. The host name must be unique
               ...
               `<id>.auto.internal`. Otherwise FQDN will be `<hostname>.<region_id>.internal`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs which assigned to resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ComputeInstanceLocalDiskArgs', 'ComputeInstanceLocalDiskArgsDict']]]] local_disks: List of local disks that are attached to the instance. > Local disks are not available for all users by default.
        :param pulumi.Input[builtins.str] maintenance_grace_period: Time between notification via metadata service and maintenance. E.g., `60s`.
        :param pulumi.Input[builtins.str] maintenance_policy: Behavior on maintenance events. Can be: `unspecified`, `migrate`, `restart`. The default is `unspecified`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: Metadata key/value pairs to make available from within the instance.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['ComputeInstanceSecondaryDiskArgs', 'ComputeInstanceSecondaryDiskArgsDict']]]] secondary_disks: A set of disks to attach to the instance. The structure is documented below. > The `allow_stopping_for_update` property
               must be set to `true` in order to update this structure.
        :param pulumi.Input[builtins.str] service_account_id: [Service account](https://yandex.cloud/docs/iam/concepts/users/service-accounts) which linked to the resource.
        :param pulumi.Input[builtins.str] zone: The [availability zone](https://yandex.cloud/docs/overview/concepts/geo-scope) where resource is located. If it is not
               provided, the default provider zone will be used.
    ...
    @property
    @pulumi.getter(name="allowRecreate")
    def allow_recreate(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "allow_recreate")
    ...
    @property
    @pulumi.getter(name="gpuClusterId")
    def gpu_cluster_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the GPU cluster to attach this instance to.
        """
        return pulumi.get(self, "gpu_cluster_id")
    ...
    @property
    @pulumi.getter(name="maintenanceGracePeriod")
    def maintenance_grace_period(self) -> pulumi.Output[builtins.str]:
        """
        Time between notification via metadata service and maintenance. E.g., `60s`.
        """
        return pulumi.get(self, "maintenance_grace_period")
    ...
    @property
    @pulumi.getter(name="maintenancePolicy")
    def maintenance_policy(self) -> pulumi.Output[builtins.str]:
        """
        Behavior on maintenance events. Can be: `unspecified`, `migrate`, `restart`. The default is `unspecified`.
        """
        return pulumi.get(self, "maintenance_policy")
    ...
    @property
    @pulumi.getter(name="networkAccelerationType")
    def network_acceleration_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Type of network acceleration. Can be `standard` or `software_accelerated`. The default is `standard`.
        """
        return pulumi.get(self, "network_acceleration_type")
    ...
    @property
    @pulumi.getter(name="platformId")
    def platform_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type of virtual machine to create.
        """
        return pulumi.get(self, "platform_id")
