...
class ComputeInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] allow_stopping_for_update: If `true`, allows Terraform to stop the instance in order to update its properties. If you try to update a property that requires stopping the instance without setting this field, the update will fail.
