...
class FunctionIamBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] function_id: The [Yandex Cloud Function](https://yandex.cloud/docs/functions/) ID to apply a binding to.
    ...
    def function_id(self) -> pulumi.Input[builtins.str]:
        """
        The [Yandex Cloud Function](https://yandex.cloud/docs/functions/) ID to apply a binding to.
        """
...
@pulumi.type_token("yandex:index/functionIamBinding:FunctionIamBinding")
class FunctionIamBinding(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            members: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None,
            sleep_after: Optional[pulumi.Input[builtins.int]] = None) -> 'FunctionIamBinding':
        """
