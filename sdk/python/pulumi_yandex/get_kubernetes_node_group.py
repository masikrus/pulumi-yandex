...
class GetKubernetesNodeGroupResult:
    ...
    def node_labels(self) -> Mapping[str, builtins.str]:
        return pulumi.get(self, "node_labels")

    @property
    @pulumi.getter(name="nodeTaints")
    def node_taints(self) -> Sequence[builtins.str]:
...
def get_kubernetes_node_group(folder_id: Optional[builtins.str] = None,
...
def get_kubernetes_node_group_output(folder_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     node_group_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
