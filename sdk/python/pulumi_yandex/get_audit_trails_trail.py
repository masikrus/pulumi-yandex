...
class GetAuditTrailsTrailResult:
    ...
    def trail_id(self) -> builtins.str:
...
def get_audit_trails_trail(trail_id: Optional[builtins.str] = None,
...
def get_audit_trails_trail_output(trail_id: Optional[pulumi.Input[builtins.str]] = None,
