...
class MessageQueueArgs:
    def __init__(__self__, *,
                 ...
                 delay_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 fifo_queue: Optional[pulumi.Input[builtins.bool]] = None,
                 max_message_size: Optional[pulumi.Input[builtins.int]] = None,
                 message_retention_seconds: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] access_key: The [access key](https://yandex.cloud/docs/iam/operations/sa/create-access-key) to use when applying changes. If
        ...
        :param pulumi.Input[builtins.bool] content_based_deduplication: Enables [content-based
        ...
        :param pulumi.Input[builtins.int] delay_seconds: Number of seconds to [delay the message from being available for
        ...
        :param pulumi.Input[builtins.bool] fifo_queue: Is this queue [FIFO](https://yandex.cloud/docs/message-queue/concepts/queue#fifo-queues). If this parameter is not used,
               a standard queue is created. You cannot change the parameter value for a created queue.
        :param pulumi.Input[builtins.int] max_message_size: Maximum message size in bytes. Valid values: from 1024 bytes (1 KB) to 262144 bytes (256 KB). Default: 262144 (256 KB).
               For more information see [documentation](https://yandex.cloud/docs/message-queue/api-ref/queue/CreateQueue).
        :param pulumi.Input[builtins.int] message_retention_seconds: The length of time in seconds to retain a message. Valid values: from 60 seconds (1 minute) to 1209600 seconds (14
        ...
        :param pulumi.Input[builtins.str] name: Queue name. The maximum length is 80 characters. You can use numbers, letters, underscores, and hyphens in the name. The
               ...
               [documentation](https://yandex.cloud/docs/message-queue/api-ref/queue/CreateQueue).
        :param pulumi.Input[builtins.str] name_prefix: Generates random name with the specified prefix. Conflicts with `name`.
        :param pulumi.Input[builtins.int] receive_wait_time_seconds: Wait time for the [ReceiveMessage](https://yandex.cloud/docs/message-queue/api-ref/message/ReceiveMessage) method (for
        ...
        :param pulumi.Input[builtins.str] redrive_policy: Message redrive policy in [Dead Letter Queue](https://yandex.cloud/docs/message-queue/concepts/dlq). The source queue
               ...
               in this page.
        :param pulumi.Input[builtins.str] region_id: ID of the region where the message queue is located at. The default is 'ru-central1'.
        :param pulumi.Input[builtins.str] secret_key: The [secret key](https://yandex.cloud/docs/iam/operations/sa/create-access-key) to use when applying changes. If
               omitted, `ymq_secret_key` specified in provider config is used. For more information see
               [documentation](https://yandex.cloud/docs/message-queue/quickstart).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: SQS tags
        :param pulumi.Input[builtins.int] visibility_timeout_seconds: [Visibility timeout](https://yandex.cloud/docs/message-queue/concepts/visibility-timeout) for messages in a queue,
    ...
    def access_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The [access key](https://yandex.cloud/docs/iam/operations/sa/create-access-key) to use when applying changes. If
        omitted, `ymq_access_key` specified in provider config is used. For more information see
        [documentation](https://yandex.cloud/docs/message-queue/quickstart).
        """
    ...
    def delay_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of seconds to [delay the message from being available for
        processing](https://yandex.cloud/docs/message-queue/concepts/delay-queues#delay-queues). Valid values: from 0 to 900
        seconds (15 minutes). Default: 0.
        """
    ...
    def delay_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def fifo_queue(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Is this queue [FIFO](https://yandex.cloud/docs/message-queue/concepts/queue#fifo-queues). If this parameter is not used,
        a standard queue is created. You cannot change the parameter value for a created queue.
        """
    ...
    def max_message_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Maximum message size in bytes. Valid values: from 1024 bytes (1 KB) to 262144 bytes (256 KB). Default: 262144 (256 KB).
        For more information see [documentation](https://yandex.cloud/docs/message-queue/api-ref/queue/CreateQueue).
        """
    ...
    def message_retention_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The length of time in seconds to retain a message. Valid values: from 60 seconds (1 minute) to 1209600 seconds (14
        days). Default: 345600 (4 days). For more information see
        [documentation](https://yandex.cloud/docs/message-queue/api-ref/queue/CreateQueue).
        """
    ...
    def message_retention_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Queue name. The maximum length is 80 characters. You can use numbers, letters, underscores, and hyphens in the name. The
        name of a FIFO queue must end with the `.fifo` suffix. If not specified, random name will be generated. Conflicts with
        `name_prefix`. For more information see
        [documentation](https://yandex.cloud/docs/message-queue/api-ref/queue/CreateQueue).
        """
    ...
    def receive_wait_time_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Wait time for the [ReceiveMessage](https://yandex.cloud/docs/message-queue/api-ref/message/ReceiveMessage) method (for
        long polling), in seconds. Valid values: from 0 to 20 seconds. Default: 0. For more information about long polling see
        [documentation](https://yandex.cloud/docs/message-queue/concepts/long-polling).
        """
    ...
    def redrive_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def redrive_policy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def secret_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The [secret key](https://yandex.cloud/docs/iam/operations/sa/create-access-key) to use when applying changes. If
        omitted, `ymq_secret_key` specified in provider config is used. For more information see
        [documentation](https://yandex.cloud/docs/message-queue/quickstart).
        """
    ...
    def visibility_timeout_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        [Visibility timeout](https://yandex.cloud/docs/message-queue/concepts/visibility-timeout) for messages in a queue,
        specified in seconds. Valid values: from 0 to 43200 seconds (12 hours). Default: 30.
        """
...
class _MessageQueueState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_key: The [access key](https://yandex.cloud/docs/iam/operations/sa/create-access-key) to use when applying changes. If
               omitted, `ymq_access_key` specified in provider config is used. For more information see
               [documentation](https://yandex.cloud/docs/message-queue/quickstart).
        :param pulumi.Input[builtins.str] arn: ARN of the Yandex Message Queue. It is used for setting up a [redrive
    ...
    def arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ARN of the Yandex Message Queue. It is used for setting up a [redrive
        policy](https://yandex.cloud/docs/message-queue/concepts/dlq). See
        [documentation](https://yandex.cloud/docs/message-queue/api-ref/queue/SetQueueAttributes).
        """
...
class MessageQueue(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secret_key: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            visibility_timeout_seconds: Optional[pulumi.Input[builtins.int]] = None) -> 'MessageQueue':
        """
    ...
    @property
    @pulumi.getter(name="contentBasedDeduplication")
    def content_based_deduplication(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enables [content-based
        deduplication](https://yandex.cloud/docs/message-queue/concepts/deduplication#content-based-deduplication). Can be used
        only if queue is [FIFO](https://yandex.cloud/docs/message-queue/concepts/queue#fifo-queues).
    ...
    @property
    @pulumi.getter(name="delaySeconds")
    def delay_seconds(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Number of seconds to [delay the message from being available for
        processing](https://yandex.cloud/docs/message-queue/concepts/delay-queues#delay-queues). Valid values: from 0 to 900
        seconds (15 minutes). Default: 0.
    ...
    @property
    @pulumi.getter(name="fifoQueue")
    def fifo_queue(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Is this queue [FIFO](https://yandex.cloud/docs/message-queue/concepts/queue#fifo-queues). If this parameter is not used,
        a standard queue is created. You cannot change the parameter value for a created queue.
        """
    ...
    @property
    @pulumi.getter(name="maxMessageSize")
    def max_message_size(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Maximum message size in bytes. Valid values: from 1024 bytes (1 KB) to 262144 bytes (256 KB). Default: 262144 (256 KB).
        For more information see [documentation](https://yandex.cloud/docs/message-queue/api-ref/queue/CreateQueue).
        """
    ...
    @property
    @pulumi.getter(name="messageRetentionSeconds")
    def message_retention_seconds(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The length of time in seconds to retain a message. Valid values: from 60 seconds (1 minute) to 1209600 seconds (14
        days). Default: 345600 (4 days). For more information see
        [documentation](https://yandex.cloud/docs/message-queue/api-ref/queue/CreateQueue).
    ...
    @property
    @pulumi.getter(name="redrivePolicy")
    def redrive_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Message redrive policy in [Dead Letter Queue](https://yandex.cloud/docs/message-queue/concepts/dlq). The source queue
        and DLQ must be the same type: for FIFO queues, the DLQ must also be a FIFO queue. For more information about redrive
        policy see [documentation](https://yandex.cloud/docs/message-queue/api-ref/queue/CreateQueue). Also you can use example
