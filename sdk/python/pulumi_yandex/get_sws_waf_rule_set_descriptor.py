...
class GetSwsWafRuleSetDescriptorResult:
    ...
    def rule_set_descriptor_id(self) -> Optional[builtins.str]:
...
def get_sws_waf_rule_set_descriptor(name: Optional[builtins.str] = None,
                                    rule_set_descriptor_id: Optional[builtins.str] = None,
...
def get_sws_waf_rule_set_descriptor_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                           rule_set_descriptor_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
