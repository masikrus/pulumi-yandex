...
def get_organizationmanager_os_login_settings(organization_id: Optional[builtins.str] = None,
...
def get_organizationmanager_os_login_settings_output(organization_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
