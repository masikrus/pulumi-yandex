...
def get_monitoring_dashboard(dashboard_id: Optional[builtins.str] = None,
...
def get_monitoring_dashboard_output(dashboard_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
