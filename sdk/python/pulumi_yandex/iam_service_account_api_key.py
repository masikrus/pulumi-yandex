...
class IamServiceAccountApiKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] scope: The scope of the key. Use `lifecycle {ignore_changes = [scope]}` directive to avoid false changes on apply.
        ...
        if scope is not None:
            warnings.warn("""Attribute `scope` is deprecated and will be removed in the next major version of the provider. Use attribute `scopes` instead.""", DeprecationWarning)
            pulumi.log.warn("""scope is deprecated: Attribute `scope` is deprecated and will be removed in the next major version of the provider. Use attribute `scopes` instead.""")
        if scope is not None:
    ...
    @_builtins.property
    @pulumi.getter
    @_utilities.deprecated("""Attribute `scope` is deprecated and will be removed in the next major version of the provider. Use attribute `scopes` instead.""")
