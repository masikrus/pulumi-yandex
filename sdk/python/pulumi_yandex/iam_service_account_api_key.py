...
class IamServiceAccountApiKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] service_account_id: ID of the service account to an API key for.
        :param pulumi.Input[builtins.str] description: The resource description.
        :param pulumi.Input[builtins.str] expires_at: The key will be no longer valid after expiration timestamp.
        ...
        :param pulumi.Input[builtins.str] pgp_key: An optional PGP key to encrypt the resulting secret key material. May either be a base64-encoded public key or a keybase
               username in the form `keybase:keybaseusername`.
        :param pulumi.Input[builtins.str] scope: The scope of the key.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scopes: The list of scopes of the key.
        """
...
class _IamServiceAccountApiKeyState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 encrypted_secret_key: Optional[pulumi.Input[builtins.str]] = None,
                 expires_at: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: The resource description.
        :param pulumi.Input[builtins.str] encrypted_secret_key: The encrypted secret key, base64 encoded. This is only populated when `pgp_key` is supplied.
        :param pulumi.Input[builtins.str] expires_at: The key will be no longer valid after expiration timestamp.
        :param pulumi.Input[builtins.str] key_fingerprint: The fingerprint of the PGP key used to encrypt the secret key. This is only populated when `pgp_key` is supplied.
        :param pulumi.Input['IamServiceAccountApiKeyOutputToLockboxArgs'] output_to_lockbox: option to create a Lockbox secret version from sensitive outputs
        ...
        :param pulumi.Input[builtins.str] scope: The scope of the key.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scopes: The list of scopes of the key.
        :param pulumi.Input[builtins.str] secret_key: The secret key. This is only populated when neither `pgp_key` nor `output_to_lockbox` are provided.
        :param pulumi.Input[builtins.str] service_account_id: ID of the service account to an API key for.
        """
    ...
    def encrypted_secret_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def encrypted_secret_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
class IamServiceAccountApiKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            scopes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            secret_key: Optional[pulumi.Input[builtins.str]] = None,
            service_account_id: Optional[pulumi.Input[builtins.str]] = None) -> 'IamServiceAccountApiKey':
        """
    ...
    @property
    @pulumi.getter(name="encryptedSecretKey")
    def encrypted_secret_key(self) -> pulumi.Output[builtins.str]:
        """
        The encrypted secret key, base64 encoded. This is only populated when `pgp_key` is supplied.
        """
        return pulumi.get(self, "encrypted_secret_key")
