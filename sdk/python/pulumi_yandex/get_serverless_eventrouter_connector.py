...
def get_serverless_eventrouter_connector(connector_id: Optional[builtins.str] = None,
...
def get_serverless_eventrouter_connector_output(connector_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
