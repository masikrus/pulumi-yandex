...
def get_iam_service_account(folder_id: Optional[_builtins.str] = None,
...
def get_iam_service_account_output(folder_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
