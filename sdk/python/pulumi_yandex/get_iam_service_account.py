...
def get_iam_service_account(folder_id: Optional[builtins.str] = None,
...
def get_iam_service_account_output(folder_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
