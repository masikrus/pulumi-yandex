...
class DnsZoneIamBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] dns_zone_id: The [DNS](https://yandex.cloud/docs/dns/) Zone ID to apply a binding to.
...
@pulumi.type_token("yandex:index/dnsZoneIamBinding:DnsZoneIamBinding")
class DnsZoneIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a DnsZoneIamBinding resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            members: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None,
            sleep_after: Optional[pulumi.Input[builtins.int]] = None) -> 'DnsZoneIamBinding':
        """
