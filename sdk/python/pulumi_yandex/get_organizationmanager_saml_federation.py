...
def get_organizationmanager_saml_federation(federation_id: Optional[builtins.str] = None,
...
def get_organizationmanager_saml_federation_output(federation_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
