...
def get_iot_core_registry(folder_id: Optional[builtins.str] = None,
...
def get_iot_core_registry_output(folder_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
