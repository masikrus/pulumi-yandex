...
class GetKubernetesClusterResult:
    ...
    def cluster_ipv4_range(self) -> builtins.str:
        return pulumi.get(self, "cluster_ipv4_range")

    @property
    @pulumi.getter(name="clusterIpv6Range")
    def cluster_ipv6_range(self) -> builtins.str:
    ...
    def service_ipv4_range(self) -> builtins.str:
        return pulumi.get(self, "service_ipv4_range")

    @property
    @pulumi.getter(name="serviceIpv6Range")
    def service_ipv6_range(self) -> builtins.str:
...
def get_kubernetes_cluster(cluster_id: Optional[builtins.str] = None,
...
def get_kubernetes_cluster_output(cluster_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
