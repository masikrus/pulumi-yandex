...
class YdbDatabaseIamBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] database_id: The [Managed Service YDB instance](https://yandex.cloud/docs/ydb/) Database ID to apply a binding to.
...
@pulumi.type_token("yandex:index/ydbDatabaseIamBinding:YdbDatabaseIamBinding")
class YdbDatabaseIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a YdbDatabaseIamBinding resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            members: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None,
            sleep_after: Optional[pulumi.Input[builtins.int]] = None) -> 'YdbDatabaseIamBinding':
        """
