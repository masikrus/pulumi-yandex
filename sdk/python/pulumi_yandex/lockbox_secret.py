...
class LockboxSecretArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] kms_key_id: The KMS key used to encrypt the Yandex Cloud Lockbox secret.
...
class _LockboxSecretState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The resource name.
        :param pulumi.Input['LockboxSecretPasswordPayloadSpecificationArgs'] password_payload_specification: Payload specification for password generation.
        :param pulumi.Input[_builtins.str] status: The Yandex Cloud Lockbox secret status.
        """
...
@pulumi.type_token("yandex:index/lockboxSecret:LockboxSecret")
class LockboxSecret(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a LockboxSecret resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            password_payload_specification: Optional[pulumi.Input[Union['LockboxSecretPasswordPayloadSpecificationArgs', 'LockboxSecretPasswordPayloadSpecificationArgsDict']]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None) -> 'LockboxSecret':
        """
