...
class GetDnsZoneResult:
    ...
    def private_networks(self) -> Sequence[builtins.str]:
...
def get_dns_zone(dns_zone_id: Optional[builtins.str] = None,
...
def get_dns_zone_output(dns_zone_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
