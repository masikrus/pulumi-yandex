...
class GetIotCoreDeviceResult:
    ...
    @property
    @pulumi.getter
    def aliases(self) -> Mapping[str, builtins.str]:
    ...
    @property
    @pulumi.getter
    def passwords(self) -> Sequence[builtins.str]:
...
def get_iot_core_device(device_id: Optional[builtins.str] = None,
...
def get_iot_core_device_output(device_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
