...
class KubernetesClusterArgs:
    def __init__(__self__, *,
                 ...
                 node_service_account_id: pulumi.Input[builtins.str],
                 service_account_id: pulumi.Input[builtins.str],
                 cluster_ipv4_range: Optional[pulumi.Input[builtins.str]] = None,
                 cluster_ipv6_range: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 network_policy_provider: Optional[pulumi.Input[builtins.str]] = None,
                 node_ipv4_cidr_mask_size: Optional[pulumi.Input[builtins.int]] = None,
                 release_channel: Optional[pulumi.Input[builtins.str]] = None,
                 service_ipv4_range: Optional[pulumi.Input[builtins.str]] = None,
                 service_ipv6_range: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a KubernetesCluster resource.
        :param pulumi.Input['KubernetesClusterMasterArgs'] master: Kubernetes master configuration options.
        :param pulumi.Input[builtins.str] network_id: The ID of the cluster network.
        :param pulumi.Input[builtins.str] node_service_account_id: Service account to be used by the worker nodes of the Kubernetes cluster to access Container Registry or to push node
               logs and metrics.
        :param pulumi.Input[builtins.str] service_account_id: Service account to be used for provisioning Compute Cloud and VPC resources for Kubernetes cluster. Selected service
        ...
        :param pulumi.Input[builtins.str] cluster_ipv4_range: CIDR block. IP range for allocating pod addresses. It should not overlap with any subnet in the network the Kubernetes
               cluster located in. Static routes will be set up for this CIDR blocks in node subnets.
        :param pulumi.Input[builtins.str] cluster_ipv6_range: Identical to `cluster_ipv4_range` but for IPv6 protocol.
        ...
        :param pulumi.Input[builtins.str] network_policy_provider: Network policy provider for the cluster. Possible values: `CALICO`.
        :param pulumi.Input[builtins.int] node_ipv4_cidr_mask_size: Size of the masks that are assigned to each node in the cluster. Effectively limits maximum number of pods for each
               node.
        :param pulumi.Input[builtins.str] release_channel: Cluster release channel.
        :param pulumi.Input[builtins.str] service_ipv4_range: CIDR block. IP range Kubernetes service Kubernetes cluster IP addresses will be allocated from. It should not overlap
               with any subnet in the network the Kubernetes cluster located in.
        :param pulumi.Input[builtins.str] service_ipv6_range: Identical to service_ipv4_range but for IPv6 protocol.
        """
    ...
    def node_service_account_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def node_service_account_id(self, value: pulumi.Input[builtins.str]):
    ...
    def cluster_ipv4_range(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cluster_ipv4_range(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cluster_ipv4_range", value)

    @property
    @pulumi.getter(name="clusterIpv6Range")
    def cluster_ipv6_range(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cluster_ipv6_range(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def network_policy_provider(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def network_policy_provider(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "network_policy_provider", value)

    @property
    @pulumi.getter(name="nodeIpv4CidrMaskSize")
    def node_ipv4_cidr_mask_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def node_ipv4_cidr_mask_size(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def service_ipv4_range(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def service_ipv4_range(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_ipv4_range", value)

    @property
    @pulumi.getter(name="serviceIpv6Range")
    def service_ipv6_range(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def service_ipv6_range(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _KubernetesClusterState:
    def __init__(__self__, *,
                 ...
                 network_policy_provider: Optional[pulumi.Input[builtins.str]] = None,
                 node_ipv4_cidr_mask_size: Optional[pulumi.Input[builtins.int]] = None,
                 node_service_account_id: Optional[pulumi.Input[builtins.str]] = None,
                 release_channel: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: The resource description.
        :param pulumi.Input[builtins.str] folder_id: The folder identifier that resource belongs to. If it is not provided, the default provider `folder-id` is used.
        :param pulumi.Input[builtins.str] health: Health of the Kubernetes cluster.
        :param pulumi.Input['KubernetesClusterKmsProviderArgs'] kms_provider: Cluster KMS provider parameters.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs which assigned to resource.
        :param pulumi.Input[builtins.str] log_group_id: Log group where cluster stores cluster system logs, like audit, events, or control plane logs.
        :param pulumi.Input['KubernetesClusterMasterArgs'] master: Kubernetes master configuration options.
        :param pulumi.Input[builtins.str] name: The resource name.
        :param pulumi.Input[builtins.str] network_id: The ID of the cluster network.
        :param pulumi.Input['KubernetesClusterNetworkImplementationArgs'] network_implementation: Network Implementation options.
        ...
        :param pulumi.Input[builtins.str] service_ipv4_range: CIDR block. IP range Kubernetes service Kubernetes cluster IP addresses will be allocated from. It should not overlap
               with any subnet in the network the Kubernetes cluster located in.
        :param pulumi.Input[builtins.str] service_ipv6_range: Identical to service_ipv4_range but for IPv6 protocol.
        :param pulumi.Input[builtins.str] status: Status of the Kubernetes cluster.
        """
        if cluster_ipv4_range is not None:
            pulumi.set(__self__, "cluster_ipv4_range", cluster_ipv4_range)
        if cluster_ipv6_range is not None:
    ...
    @property
    @pulumi.getter(name="nodeServiceAccountId")
    def node_service_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Service account to be used by the worker nodes of the Kubernetes cluster to access Container Registry or to push node
        logs and metrics.
        """
    ...
    @node_service_account_id.setter
    def node_service_account_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "node_service_account_id", value)
...
class KubernetesCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_ipv4_range: Optional[pulumi.Input[builtins.str]] = None,
            service_ipv6_range: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'KubernetesCluster':
        """
    ...
    @property
    @pulumi.getter(name="clusterIpv4Range")
    def cluster_ipv4_range(self) -> pulumi.Output[builtins.str]:
        """
        CIDR block. IP range for allocating pod addresses. It should not overlap with any subnet in the network the Kubernetes
        cluster located in. Static routes will be set up for this CIDR blocks in node subnets.
        """
    ...
    @property
    @pulumi.getter(name="clusterIpv6Range")
    def cluster_ipv6_range(self) -> pulumi.Output[builtins.str]:
        """
        Identical to `cluster_ipv4_range` but for IPv6 protocol.
        """
        return pulumi.get(self, "cluster_ipv6_range")
    ...
    @property
    @pulumi.getter(name="networkPolicyProvider")
    def network_policy_provider(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Network policy provider for the cluster. Possible values: `CALICO`.
        """
        return pulumi.get(self, "network_policy_provider")
    ...
    @property
    @pulumi.getter(name="nodeIpv4CidrMaskSize")
    def node_ipv4_cidr_mask_size(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Size of the masks that are assigned to each node in the cluster. Effectively limits maximum number of pods for each
        node.
        """
    ...
    @property
    @pulumi.getter(name="nodeServiceAccountId")
    def node_service_account_id(self) -> pulumi.Output[builtins.str]:
        """
        Service account to be used by the worker nodes of the Kubernetes cluster to access Container Registry or to push node
        logs and metrics.
        """
    ...
    @property
    @pulumi.getter(name="serviceIpv4Range")
    def service_ipv4_range(self) -> pulumi.Output[builtins.str]:
        """
        CIDR block. IP range Kubernetes service Kubernetes cluster IP addresses will be allocated from. It should not overlap
        with any subnet in the network the Kubernetes cluster located in.
        """
    ...
    @property
    @pulumi.getter(name="serviceIpv6Range")
    def service_ipv6_range(self) -> pulumi.Output[builtins.str]:
        """
        Identical to service_ipv4_range but for IPv6 protocol.
        """
        return pulumi.get(self, "service_ipv6_range")
