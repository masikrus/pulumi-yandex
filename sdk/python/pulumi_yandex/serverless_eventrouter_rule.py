...
class ServerlessEventrouterRuleArgs:
    def __init__(__self__, *,
                 bus_id: pulumi.Input[builtins.str],
                 ...
                 jq_filter: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] bus_id: ID of the bus that the rule belongs to
        ...
        :param pulumi.Input[builtins.str] jq_filter: JQ filter for matching events
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Rule labels
    ...
    def bus_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @bus_id.setter
    def bus_id(self, value: pulumi.Input[builtins.str]):
    ...
    def jq_filter(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @jq_filter.setter
    def jq_filter(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ServerlessEventrouterRuleState:
    def __init__(__self__, *,
                 bus_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] bus_id: ID of the bus that the rule belongs to
        :param pulumi.Input[builtins.str] cloud_id: ID of the cloud that the rule resides in
        :param pulumi.Input[Sequence[pulumi.Input['ServerlessEventrouterRuleContainerArgs']]] containers: ContainerTarget
        :param pulumi.Input[builtins.str] created_at: Creation timestamp
        :param pulumi.Input[builtins.bool] deletion_protection: Deletion protection
        :param pulumi.Input[builtins.str] description: Description of the rule
        :param pulumi.Input[builtins.str] folder_id: ID of the folder that the rule resides in
        :param pulumi.Input[Sequence[pulumi.Input['ServerlessEventrouterRuleFunctionArgs']]] functions: FunctionTarget
        :param pulumi.Input[Sequence[pulumi.Input['ServerlessEventrouterRuleGatewayWebsocketBroadcastArgs']]] gateway_websocket_broadcasts: GatewayWebsocketBroadcastTarget
        :param pulumi.Input[builtins.str] jq_filter: JQ filter for matching events
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Rule labels
    ...
    @property
    @pulumi.getter(name="busId")
    def bus_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ID of the bus that the rule belongs to
        """
        return pulumi.get(self, "bus_id")
    ...
    @bus_id.setter
    def bus_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bus_id", value)
...
class ServerlessEventrouterRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ServerlessEventrouterRule resource with the given unique name, props, and options.
    ...
    @property
    @pulumi.getter(name="busId")
    def bus_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the bus that the rule belongs to
        """
        return pulumi.get(self, "bus_id")
    ...
    @property
    @pulumi.getter(name="jqFilter")
    def jq_filter(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        JQ filter for matching events
        """
        return pulumi.get(self, "jq_filter")
