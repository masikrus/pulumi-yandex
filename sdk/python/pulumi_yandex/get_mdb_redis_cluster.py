...
class GetMdbRedisClusterResult:
    ...
    def announce_hostnames(self) -> _builtins.bool:
        return pulumi.get(self, "announce_hostnames")

    @_builtins.property
    @pulumi.getter(name="authSentinel")
    def auth_sentinel(self) -> _builtins.bool:
...
def get_mdb_redis_cluster(cluster_id: Optional[_builtins.str] = None,
...
def get_mdb_redis_cluster_output(cluster_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
