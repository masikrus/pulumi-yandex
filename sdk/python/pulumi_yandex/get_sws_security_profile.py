...
class GetSwsSecurityProfileResult:
    ...
    def advanced_rate_limiter_profile_id(self) -> builtins.str:
    ...
    def security_profile_id(self) -> Optional[builtins.str]:
...
def get_sws_security_profile(cloud_id: Optional[builtins.str] = None,
...
def get_sws_security_profile_output(cloud_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
