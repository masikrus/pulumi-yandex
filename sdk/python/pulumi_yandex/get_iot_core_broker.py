...
class GetIotCoreBrokerResult:
    ...
    def broker_id(self) -> Optional[builtins.str]:
...
def get_iot_core_broker(broker_id: Optional[builtins.str] = None,
...
def get_iot_core_broker_output(broker_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
