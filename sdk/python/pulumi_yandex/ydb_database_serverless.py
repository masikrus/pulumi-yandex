...
class YdbDatabaseServerlessArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] location_id: Location ID for the Yandex Database serverless cluster.
...
class _YdbDatabaseServerlessState:
    def __init__(__self__, *,
                 ...
                 deletion_protection: Optional[pulumi.Input[builtins.bool]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 document_api_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 folder_id: Optional[pulumi.Input[builtins.str]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 location_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] database_path: Full database path of the Yandex Database serverless cluster. Useful for SDK configuration.
        :param pulumi.Input[builtins.bool] deletion_protection: The `true` value means that resource is protected from accidental deletion.
        :param pulumi.Input[builtins.str] description: The resource description.
        :param pulumi.Input[builtins.str] document_api_endpoint: Document API endpoint of the Yandex Database serverless cluster.
        :param pulumi.Input[builtins.str] folder_id: The folder identifier that resource belongs to. If it is not provided, the default provider `folder-id` is used.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs which assigned to resource.
        :param pulumi.Input[builtins.str] location_id: Location ID for the Yandex Database serverless cluster.
        :param pulumi.Input[builtins.str] name: The resource name.
        :param pulumi.Input[builtins.str] status: Status of the Yandex Database serverless cluster.
        :param pulumi.Input[builtins.bool] tls_enabled: Whether TLS is enabled for the Yandex Database serverless cluster. Useful for SDK configuration.
        :param pulumi.Input[builtins.str] ydb_api_endpoint: API endpoint of the Yandex Database serverless cluster. Useful for SDK configuration.
        :param pulumi.Input[builtins.str] ydb_full_endpoint: Full endpoint of the Yandex Database serverless cluster.
        """
    ...
    def document_api_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def document_api_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
...
class YdbDatabaseServerless(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a YdbDatabaseServerless resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            tls_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            ydb_api_endpoint: Optional[pulumi.Input[builtins.str]] = None,
            ydb_full_endpoint: Optional[pulumi.Input[builtins.str]] = None) -> 'YdbDatabaseServerless':
        """
    ...
    @property
    @pulumi.getter(name="documentApiEndpoint")
    def document_api_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        Document API endpoint of the Yandex Database serverless cluster.
        """
        return pulumi.get(self, "document_api_endpoint")
