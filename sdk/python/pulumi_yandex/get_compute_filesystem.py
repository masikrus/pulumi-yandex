...
def get_compute_filesystem(filesystem_id: Optional[builtins.str] = None,
...
def get_compute_filesystem_output(filesystem_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
