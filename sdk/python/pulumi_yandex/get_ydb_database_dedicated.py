...
class GetYdbDatabaseDedicatedResult:
    ...
    def assign_public_ips(self) -> builtins.bool:
    ...
    def database_path(self) -> builtins.str:
    ...
    def resource_preset_id(self) -> builtins.str:
    ...
    def ydb_api_endpoint(self) -> builtins.str:
        return pulumi.get(self, "ydb_api_endpoint")

    @property
    @pulumi.getter(name="ydbFullEndpoint")
    def ydb_full_endpoint(self) -> builtins.str:
...
def get_ydb_database_dedicated(database_id: Optional[builtins.str] = None,
...
def get_ydb_database_dedicated_output(database_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
