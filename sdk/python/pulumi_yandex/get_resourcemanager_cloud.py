...
def get_resourcemanager_cloud(cloud_id: Optional[builtins.str] = None,
...
def get_resourcemanager_cloud_output(cloud_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
