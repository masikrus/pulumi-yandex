...
class MdbKafkaClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] environment: Deployment environment of the Kafka cluster. Can be either `PRESTABLE` or `PRODUCTION`. The default is `PRODUCTION`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] host_group_ids: A list of IDs of the host groups to place VMs of the cluster on.
