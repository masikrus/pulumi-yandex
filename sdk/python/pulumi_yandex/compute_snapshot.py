...
class ComputeSnapshotArgs:
    def __init__(__self__, *,
                 source_disk_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] source_disk_id: ID of the disk to create a snapshot from.
        ...
        :param pulumi.Input['ComputeSnapshotHardwareGenerationArgs'] hardware_generation: Hardware generation and its features, which will be applied to the instance when this snapshot is used as a boot disk
    ...
    def source_disk_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_disk_id(self, value: pulumi.Input[builtins.str]):
...
class _ComputeSnapshotState:
    def __init__(__self__, *,
                 ...
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 source_disk_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: The resource description.
        :param pulumi.Input[builtins.int] disk_size: Size of the disk when the snapshot was created, specified in GB.
        :param pulumi.Input[builtins.str] folder_id: The folder identifier that resource belongs to. If it is not provided, the default provider `folder-id` is used.
        :param pulumi.Input['ComputeSnapshotHardwareGenerationArgs'] hardware_generation: Hardware generation and its features, which will be applied to the instance when this snapshot is used as a boot disk
               source. Provide this property if you wish to override this value, which otherwise is inherited from the source.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs which assigned to resource.
        :param pulumi.Input[builtins.str] name: The resource name.
        :param pulumi.Input[builtins.str] source_disk_id: ID of the disk to create a snapshot from.
        :param pulumi.Input[builtins.int] storage_size: Size of the snapshot, specified in GB.
        """
    ...
    @property
    @pulumi.getter(name="sourceDiskId")
    def source_disk_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ID of the disk to create a snapshot from.
        """
        return pulumi.get(self, "source_disk_id")
    ...
    @source_disk_id.setter
    def source_disk_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_disk_id", value)
...
class ComputeSnapshot(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] description: The resource description.
        :param pulumi.Input[builtins.str] folder_id: The folder identifier that resource belongs to. If it is not provided, the default provider `folder-id` is used.
        :param pulumi.Input[Union['ComputeSnapshotHardwareGenerationArgs', 'ComputeSnapshotHardwareGenerationArgsDict']] hardware_generation: Hardware generation and its features, which will be applied to the instance when this snapshot is used as a boot disk
               source. Provide this property if you wish to override this value, which otherwise is inherited from the source.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs which assigned to resource.
        :param pulumi.Input[builtins.str] name: The resource name.
        :param pulumi.Input[builtins.str] source_disk_id: ID of the disk to create a snapshot from.
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            source_disk_id: Optional[pulumi.Input[builtins.str]] = None,
            storage_size: Optional[pulumi.Input[builtins.int]] = None) -> 'ComputeSnapshot':
        """
    ...
    @property
    @pulumi.getter(name="sourceDiskId")
    def source_disk_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the disk to create a snapshot from.
        """
        return pulumi.get(self, "source_disk_id")
    ...
    @property
    @pulumi.getter(name="storageSize")
    def storage_size(self) -> pulumi.Output[builtins.int]:
        """
        Size of the snapshot, specified in GB.
        """
        return pulumi.get(self, "storage_size")
