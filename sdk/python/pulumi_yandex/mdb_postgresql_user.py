...
class MdbPostgresqlUserArgs:
    def __init__(__self__, *,
                 ...
                 conn_limit: Optional[pulumi.Input[builtins.int]] = None,
                 deletion_protection: Optional[pulumi.Input[builtins.str]] = None,
                 generate_password: Optional[pulumi.Input[builtins.bool]] = None,
                 grants: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 login: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.int] conn_limit: The maximum number of connections per user. (Default 50).
        ...
        :param pulumi.Input[builtins.bool] generate_password: Generate password using Connection Manager. Allowed values: true or false. It's used only during user creation and is
               ignored during updating. > **Must specify either password or generate_password**.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] grants: List of the user's grants.
        :param pulumi.Input[builtins.bool] login: User's ability to login.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] settings: Map of user settings. [Full
    ...
    def conn_limit(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @conn_limit.setter
    def conn_limit(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    @property
    @pulumi.getter
    def grants(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @grants.setter
    def grants(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "grants", value)

    @property
    @pulumi.getter
    def login(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @login.setter
    def login(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class MdbPostgresqlUser(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a MdbPostgresqlUser resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            password: Optional[pulumi.Input[builtins.str]] = None,
            permissions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['MdbPostgresqlUserPermissionArgs', 'MdbPostgresqlUserPermissionArgsDict']]]]] = None,
            settings: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'MdbPostgresqlUser':
        """
    ...
    @property
    @pulumi.getter(name="connLimit")
    def conn_limit(self) -> pulumi.Output[builtins.int]:
        """
        The maximum number of connections per user. (Default 50).
        """
        return pulumi.get(self, "conn_limit")
    ...
    @property
    @pulumi.getter
    def grants(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of the user's grants.
        """
        return pulumi.get(self, "grants")
    ...
    @property
    @pulumi.getter
    def login(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        User's ability to login.
        """
        return pulumi.get(self, "login")
