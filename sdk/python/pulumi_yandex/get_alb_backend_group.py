...
class GetAlbBackendGroupResult:
    ...
    def backend_group_id(self) -> builtins.str:
...
def get_alb_backend_group(backend_group_id: Optional[builtins.str] = None,
...
def get_alb_backend_group_output(backend_group_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
