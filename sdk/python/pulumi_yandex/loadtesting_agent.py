...
class _LoadtestingAgentState:
    def __init__(__self__, *,
                 ...
                 compute_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 folder_id: Optional[pulumi.Input[builtins.str]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 log_settings: Optional[pulumi.Input['LoadtestingAgentLogSettingsArgs']] = None,
        ...
        :param pulumi.Input['LoadtestingAgentComputeInstanceArgs'] compute_instance: The template for creating new compute instance running load testing agent.
        :param pulumi.Input[builtins.str] compute_instance_id: Compute Instance ID.
        :param pulumi.Input[builtins.str] description: The resource description.
        :param pulumi.Input[builtins.str] folder_id: The folder identifier that resource belongs to. If it is not provided, the default provider `folder-id` is used.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs which assigned to resource.
        :param pulumi.Input['LoadtestingAgentLogSettingsArgs'] log_settings: The logging settings of the load testing agent.
    ...
    def compute_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Compute Instance ID.
        """
    ...
    def compute_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LoadtestingAgent(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a LoadtestingAgent resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            log_settings: Optional[pulumi.Input[Union['LoadtestingAgentLogSettingsArgs', 'LoadtestingAgentLogSettingsArgsDict']]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'LoadtestingAgent':
        """
    ...
    @property
    @pulumi.getter(name="computeInstanceId")
    def compute_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        Compute Instance ID.
        """
        return pulumi.get(self, "compute_instance_id")
