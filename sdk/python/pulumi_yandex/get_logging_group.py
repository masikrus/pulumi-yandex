...
class GetLoggingGroupResult:
    ...
    def data_stream(self) -> builtins.str:
...
def get_logging_group(folder_id: Optional[builtins.str] = None,
...
def get_logging_group_output(folder_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
