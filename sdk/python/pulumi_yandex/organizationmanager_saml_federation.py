...
class OrganizationmanagerSamlFederationArgs:
    def __init__(__self__, *,
                 ...
                 sso_binding: pulumi.Input[builtins.str],
                 sso_url: pulumi.Input[builtins.str],
                 auto_create_account_on_login: Optional[pulumi.Input[builtins.bool]] = None,
                 case_insensitive_name_ids: Optional[pulumi.Input[builtins.bool]] = None,
                 cookie_max_age: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] issuer: The ID of the IdP server to be used for authentication. The IdP server also responds to IAM with this ID after the user
               authenticates.
        :param pulumi.Input[builtins.str] organization_id: The organization to attach this SAML Federation to.
        :param pulumi.Input[builtins.str] sso_binding: Single sign-on endpoint binding type. Most Identity Providers support the `POST` binding type. SAML Binding is a mapping
               of a SAML protocol message onto standard messaging formats and/or communications protocols.
        :param pulumi.Input[builtins.str] sso_url: Single sign-on (SSO) endpoint URL. Specify the link to the IdP login page here.
        :param pulumi.Input[builtins.bool] auto_create_account_on_login: Add new users automatically on successful authentication. The user will get the `resource-manager.clouds.member` role
        ...
        :param pulumi.Input[builtins.bool] case_insensitive_name_ids: Use case-insensitive name IDs.
        :param pulumi.Input[builtins.str] cookie_max_age: The lifetime of a Browser cookie in seconds. If the cookie is still valid, the management console authenticates the user
        ...
        :param pulumi.Input['OrganizationmanagerSamlFederationSecuritySettingsArgs'] security_settings: Federation security settings.
        """
    ...
    def issuer(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the IdP server to be used for authentication. The IdP server also responds to IAM with this ID after the user
        authenticates.
        """
    ...
    def sso_binding(self) -> pulumi.Input[builtins.str]:
        """
        Single sign-on endpoint binding type. Most Identity Providers support the `POST` binding type. SAML Binding is a mapping
        of a SAML protocol message onto standard messaging formats and/or communications protocols.
        """
        return pulumi.get(self, "sso_binding")

    @sso_binding.setter
    def sso_binding(self, value: pulumi.Input[builtins.str]):
    ...
    def auto_create_account_on_login(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Add new users automatically on successful authentication. The user will get the `resource-manager.clouds.member` role
        automatically, but you need to grant other roles to them. If the value is `false`, users who aren't added to the cloud
        can't log in, even if they have authenticated on your server.
        """
    ...
    def auto_create_account_on_login(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_create_account_on_login", value)

    @property
    @pulumi.getter(name="caseInsensitiveNameIds")
    def case_insensitive_name_ids(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def case_insensitive_name_ids(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "case_insensitive_name_ids", value)

    @property
    @pulumi.getter(name="cookieMaxAge")
    def cookie_max_age(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The lifetime of a Browser cookie in seconds. If the cookie is still valid, the management console authenticates the user
        immediately and redirects them to the home page. The default value is `8h`.
        """
        return pulumi.get(self, "cookie_max_age")

    @cookie_max_age.setter
    def cookie_max_age(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _OrganizationmanagerSamlFederationState:
    def __init__(__self__, *,
                 ...
                 security_settings: Optional[pulumi.Input['OrganizationmanagerSamlFederationSecuritySettingsArgs']] = None,
                 sso_binding: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="ssoBinding")
    def sso_binding(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Single sign-on endpoint binding type. Most Identity Providers support the `POST` binding type. SAML Binding is a mapping
        of a SAML protocol message onto standard messaging formats and/or communications protocols.
        """
    ...
    @sso_binding.setter
    def sso_binding(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sso_binding", value)
...
@pulumi.type_token("yandex:index/organizationmanagerSamlFederation:OrganizationmanagerSamlFederation")
class OrganizationmanagerSamlFederation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 organization_id: Optional[pulumi.Input[builtins.str]] = None,
                 security_settings: Optional[pulumi.Input[Union['OrganizationmanagerSamlFederationSecuritySettingsArgs', 'OrganizationmanagerSamlFederationSecuritySettingsArgsDict']]] = None,
                 sso_binding: Optional[pulumi.Input[builtins.str]] = None,
                 sso_url: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
        Create a OrganizationmanagerSamlFederation resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[builtins.str] name: The resource name.
        :param pulumi.Input[builtins.str] organization_id: The organization to attach this SAML Federation to.
        :param pulumi.Input[Union['OrganizationmanagerSamlFederationSecuritySettingsArgs', 'OrganizationmanagerSamlFederationSecuritySettingsArgsDict']] security_settings: Federation security settings.
        :param pulumi.Input[builtins.str] sso_binding: Single sign-on endpoint binding type. Most Identity Providers support the `POST` binding type. SAML Binding is a mapping
               of a SAML protocol message onto standard messaging formats and/or communications protocols.
        :param pulumi.Input[builtins.str] sso_url: Single sign-on (SSO) endpoint URL. Specify the link to the IdP login page here.
        """
    ...
    def get(resource_name: str,
            ...
            security_settings: Optional[pulumi.Input[Union['OrganizationmanagerSamlFederationSecuritySettingsArgs', 'OrganizationmanagerSamlFederationSecuritySettingsArgsDict']]] = None,
            sso_binding: Optional[pulumi.Input[builtins.str]] = None,
            sso_url: Optional[pulumi.Input[builtins.str]] = None) -> 'OrganizationmanagerSamlFederation':
        """
    ...
    @property
    @pulumi.getter(name="autoCreateAccountOnLogin")
    def auto_create_account_on_login(self) -> pulumi.Output[builtins.bool]:
        """
        Add new users automatically on successful authentication. The user will get the `resource-manager.clouds.member` role
        automatically, but you need to grant other roles to them. If the value is `false`, users who aren't added to the cloud
        can't log in, even if they have authenticated on your server.
    ...
    @property
    @pulumi.getter(name="caseInsensitiveNameIds")
    def case_insensitive_name_ids(self) -> pulumi.Output[builtins.bool]:
        """
        Use case-insensitive name IDs.
        """
        return pulumi.get(self, "case_insensitive_name_ids")
    ...
    @property
    @pulumi.getter(name="cookieMaxAge")
    def cookie_max_age(self) -> pulumi.Output[builtins.str]:
        """
        The lifetime of a Browser cookie in seconds. If the cookie is still valid, the management console authenticates the user
        immediately and redirects them to the home page. The default value is `8h`.
        """
    ...
    @property
    @pulumi.getter(name="ssoBinding")
    def sso_binding(self) -> pulumi.Output[builtins.str]:
        """
        Single sign-on endpoint binding type. Most Identity Providers support the `POST` binding type. SAML Binding is a mapping
        of a SAML protocol message onto standard messaging formats and/or communications protocols.
        """
    ...
    @property
    @pulumi.getter(name="ssoUrl")
    def sso_url(self) -> pulumi.Output[builtins.str]:
        """
        Single sign-on (SSO) endpoint URL. Specify the link to the IdP login page here.
        """
        return pulumi.get(self, "sso_url")
