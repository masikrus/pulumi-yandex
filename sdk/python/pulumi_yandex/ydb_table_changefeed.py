...
class YdbTableChangefeedArgs:
    def __init__(__self__, *,
                 ...
                 table_path: Optional[pulumi.Input[builtins.str]] = None,
                 virtual_timestamps: Optional[pulumi.Input[builtins.bool]] = None):
        """
    ...
    def table_path(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "table_path")

    @table_path.setter
    def table_path(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "table_path", value)

    @property
    @pulumi.getter(name="virtualTimestamps")
    def virtual_timestamps(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "virtual_timestamps")

    @virtual_timestamps.setter
    def virtual_timestamps(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class YdbTableChangefeed(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a YdbTableChangefeed resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            table_id: Optional[pulumi.Input[builtins.str]] = None,
            table_path: Optional[pulumi.Input[builtins.str]] = None,
            virtual_timestamps: Optional[pulumi.Input[builtins.bool]] = None) -> 'YdbTableChangefeed':
        """
    ...
    @property
    @pulumi.getter(name="tablePath")
    def table_path(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "table_path")

    @property
    @pulumi.getter(name="virtualTimestamps")
    def virtual_timestamps(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "virtual_timestamps")
