...
class MdbRedisClusterArgs:
    def __init__(__self__, *,
                 ...
                 announce_hostnames: Optional[pulumi.Input[builtins.bool]] = None,
                 auth_sentinel: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 sharded: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] environment: Deployment environment of the Redis cluster. Can be either `PRESTABLE` or `PRODUCTION`.
        ...
        :param pulumi.Input[builtins.bool] announce_hostnames: Announce fqdn instead of ip address.
        :param pulumi.Input[builtins.bool] auth_sentinel: Allows to use ACL users to auth in sentinel
        ...
        :param pulumi.Input[builtins.str] persistence_mode: Persistence mode. Possible values: `ON`, `OFF`.
        ...
        :param pulumi.Input[builtins.bool] sharded: Redis Cluster mode enabled/disabled. Enables sharding when cluster non-sharded. If cluster is sharded - disabling is not
               allowed.
        :param pulumi.Input[builtins.bool] tls_enabled: TLS support mode enabled/disabled.
        """
    ...
    def announce_hostnames(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def announce_hostnames(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "announce_hostnames", value)

    @property
    @pulumi.getter(name="authSentinel")
    def auth_sentinel(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auth_sentinel(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def sharded(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @sharded.setter
    def sharded(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class MdbRedisCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sharded: Optional[pulumi.Input[builtins.bool]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            tls_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'MdbRedisCluster':
        """
    ...
    @property
    @pulumi.getter(name="announceHostnames")
    def announce_hostnames(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Announce fqdn instead of ip address.
        """
        return pulumi.get(self, "announce_hostnames")
    ...
    @property
    @pulumi.getter(name="authSentinel")
    def auth_sentinel(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Allows to use ACL users to auth in sentinel
        """
        return pulumi.get(self, "auth_sentinel")
    ...
    @property
    @pulumi.getter
    def sharded(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Redis Cluster mode enabled/disabled. Enables sharding when cluster non-sharded. If cluster is sharded - disabling is not
        allowed.
        """
