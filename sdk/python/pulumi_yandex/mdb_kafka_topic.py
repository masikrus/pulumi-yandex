...
class MdbKafkaTopicArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] partitions: The number of the topic's partitions.
        :param pulumi.Input[builtins.int] replication_factor: Amount of data copies (replicas) for the topic in the cluster.
        :param pulumi.Input[builtins.str] name: The resource name.
        :param pulumi.Input['MdbKafkaTopicTopicConfigArgs'] topic_config: User-defined settings for the topic. For more information, see [the official
...
class MdbKafkaTopic(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.int] partitions: The number of the topic's partitions.
        :param pulumi.Input[builtins.int] replication_factor: Amount of data copies (replicas) for the topic in the cluster.
        :param pulumi.Input[Union['MdbKafkaTopicTopicConfigArgs', 'MdbKafkaTopicTopicConfigArgsDict']] topic_config: User-defined settings for the topic. For more information, see [the official
               documentation](https://yandex.cloud/docs/managed-kafka/concepts/settings-list#topic-settings) and [the Kafka
               documentation](https://kafka.apache.org/documentation/#topicconfigs).
        """
        ...
