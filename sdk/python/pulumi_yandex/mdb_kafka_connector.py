...
class MdbKafkaConnectorArgs:
    def __init__(__self__, *,
                 ...
                 tasks_max: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: Additional properties for connector.
        :param pulumi.Input[builtins.int] tasks_max: The number of the connector's parallel working tasks. Default is the number of brokers.
        """
    ...
    def tasks_max(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @tasks_max.setter
    def tasks_max(self, value: Optional[pulumi.Input[builtins.int]]):
...
class MdbKafkaConnector(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tasks_max: Optional[pulumi.Input[builtins.int]] = None) -> 'MdbKafkaConnector':
        """
    ...
    @property
    @pulumi.getter(name="tasksMax")
    def tasks_max(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of the connector's parallel working tasks. Default is the number of brokers.
        """
        return pulumi.get(self, "tasks_max")
