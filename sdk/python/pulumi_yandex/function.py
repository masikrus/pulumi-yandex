...
class FunctionArgs:
    def __init__(__self__, *,
                 entrypoint: pulumi.Input[builtins.str],
                 memory: pulumi.Input[builtins.int],
                 runtime: pulumi.Input[builtins.str],
                 user_hash: pulumi.Input[builtins.str],
                 ...
                 tmpfs_size: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Function resource.
        :param pulumi.Input[builtins.str] entrypoint: Entrypoint for Yandex Cloud Function.
        :param pulumi.Input[builtins.int] memory: Memory in megabytes (**aligned to 128MB**) for Yandex Cloud Function.
        :param pulumi.Input[builtins.str] runtime: Runtime for Yandex Cloud Function.
        :param pulumi.Input[builtins.str] user_hash: User-defined string for current function version. User must change this string any times when function changed. Function
        ...
        :param pulumi.Input[builtins.int] concurrency: The maximum number of requests processed by a function instance at the same time.
        ...
        :param pulumi.Input['FunctionContentArgs'] content: Version deployment content for Yandex Cloud Function code. Can be only one `package` or `content` section. Either
               `package` or `content` section must be specified.
        :param pulumi.Input[builtins.str] description: The resource description.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] environment: A set of key/value environment variables for Yandex Cloud Function. Each key must begin with a letter (A-Z, a-z).
        :param pulumi.Input[builtins.str] execution_timeout: Execution timeout in seconds for Yandex Cloud Function.
        ...
        :param pulumi.Input['FunctionPackageArgs'] package: Version deployment package for Yandex Cloud Function code. Can be only one `package` or `content` section. Either
               `package` or `content` section must be specified.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: Tags for Yandex Cloud Function. Tag `$latest` isn't returned.
        :param pulumi.Input[builtins.int] tmpfs_size: Tmpfs size for Yandex Cloud Function.
        """
    ...
    @property
    @pulumi.getter
    def entrypoint(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @entrypoint.setter
    def entrypoint(self, value: pulumi.Input[builtins.str]):
    ...
    def user_hash(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @user_hash.setter
    def user_hash(self, value: pulumi.Input[builtins.str]):
    ...
    def tmpfs_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @tmpfs_size.setter
    def tmpfs_size(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _FunctionState:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 tmpfs_size: Optional[pulumi.Input[builtins.int]] = None,
                 user_hash: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] execution_timeout: Execution timeout in seconds for Yandex Cloud Function.
        :param pulumi.Input[builtins.str] folder_id: The folder identifier that resource belongs to. If it is not provided, the default provider `folder-id` is used.
        :param pulumi.Input[builtins.int] image_size: Image size for Yandex Cloud Function.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs which assigned to resource.
        :param pulumi.Input['FunctionLogOptionsArgs'] log_options: Options for logging from Yandex Cloud Function.
        :param pulumi.Input[builtins.int] memory: Memory in megabytes (**aligned to 128MB**) for Yandex Cloud Function.
        :param pulumi.Input['FunctionMetadataOptionsArgs'] metadata_options: Options set the access mode to function's metadata endpoints.
        ...
        :param pulumi.Input[builtins.str] user_hash: User-defined string for current function version. User must change this string any times when function changed. Function
               will be updated when hash is changed.
        :param pulumi.Input[builtins.str] version: Version of Yandex Cloud Function.
        """
        if async_invocation is not None:
            pulumi.set(__self__, "async_invocation", async_invocation)
        if concurrency is not None:
    ...
    @property
    @pulumi.getter(name="userHash")
    def user_hash(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        User-defined string for current function version. User must change this string any times when function changed. Function
        will be updated when hash is changed.
        """
    ...
    @user_hash.setter
    def user_hash(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "user_hash", value)
...
class Function(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['FunctionContentArgs', 'FunctionContentArgsDict']] content: Version deployment content for Yandex Cloud Function code. Can be only one `package` or `content` section. Either
               `package` or `content` section must be specified.
        :param pulumi.Input[builtins.str] description: The resource description.
        :param pulumi.Input[builtins.str] entrypoint: Entrypoint for Yandex Cloud Function.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] environment: A set of key/value environment variables for Yandex Cloud Function. Each key must begin with a letter (A-Z, a-z).
        ...
        :param pulumi.Input[builtins.str] name: The resource name.
        :param pulumi.Input[Union['FunctionPackageArgs', 'FunctionPackageArgsDict']] package: Version deployment package for Yandex Cloud Function code. Can be only one `package` or `content` section. Either
               `package` or `content` section must be specified.
        :param pulumi.Input[builtins.str] runtime: Runtime for Yandex Cloud Function.
    ...
    def get(resource_name: str,
            ...
            tmpfs_size: Optional[pulumi.Input[builtins.int]] = None,
            user_hash: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'Function':
        """
    ...
    @property
    @pulumi.getter
    def entrypoint(self) -> pulumi.Output[builtins.str]:
        """
        Entrypoint for Yandex Cloud Function.
        """
        return pulumi.get(self, "entrypoint")
    ...
    @property
    @pulumi.getter(name="imageSize")
    def image_size(self) -> pulumi.Output[builtins.int]:
        """
        Image size for Yandex Cloud Function.
        """
        return pulumi.get(self, "image_size")
    ...
    @property
    @pulumi.getter(name="tmpfsSize")
    def tmpfs_size(self) -> pulumi.Output[builtins.int]:
        """
        Tmpfs size for Yandex Cloud Function.
        """
        return pulumi.get(self, "tmpfs_size")
    ...
    @property
    @pulumi.getter(name="userHash")
    def user_hash(self) -> pulumi.Output[builtins.str]:
        """
        User-defined string for current function version. User must change this string any times when function changed. Function
        will be updated when hash is changed.
        """
