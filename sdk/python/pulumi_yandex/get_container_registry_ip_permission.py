...
class GetContainerRegistryIpPermissionResult:
    ...
    @property
    @pulumi.getter
    def pulls(self) -> Sequence[builtins.str]:
        return pulumi.get(self, "pulls")

    @property
    @pulumi.getter
    def pushes(self) -> Sequence[builtins.str]:
...
def get_container_registry_ip_permission(registry_id: Optional[builtins.str] = None,
...
def get_container_registry_ip_permission_output(registry_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                registry_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
