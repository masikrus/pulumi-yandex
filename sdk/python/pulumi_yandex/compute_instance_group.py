...
class ComputeInstanceGroupArgs:
    def __init__(__self__, *,
                 ...
                 max_checking_health_duration: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input['ComputeInstanceGroupScalePolicyArgs'] scale_policy: The scaling policy of the instance group. > Either `fixed_scale` or `auto_scale` must be specified.
        ...
        :param pulumi.Input[builtins.int] max_checking_health_duration: Timeout for waiting for the VM to become healthy. If the timeout is exceeded, the VM will be turned off based on the
               deployment policy. Specified in seconds.
        :param pulumi.Input[builtins.str] name: The resource name.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] variables: A set of key/value variables pairs to assign to the instance group.
        """
    ...
    def max_checking_health_duration(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_checking_health_duration(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _ComputeInstanceGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ComputeInstanceGroupScalePolicyArgs'] scale_policy: The scaling policy of the instance group. > Either `fixed_scale` or `auto_scale` must be specified.
        :param pulumi.Input[builtins.str] service_account_id: [Service account](https://yandex.cloud/docs/iam/concepts/users/service-accounts) which linked to the resource.
        :param pulumi.Input[builtins.str] status: The status of the instance.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] variables: A set of key/value variables pairs to assign to the instance group.
        """
...
class ComputeInstanceGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.int] max_checking_health_duration: Timeout for waiting for the VM to become healthy. If the timeout is exceeded, the VM will be turned off based on the
               deployment policy. Specified in seconds.
        :param pulumi.Input[builtins.str] name: The resource name.
        :param pulumi.Input[Union['ComputeInstanceGroupScalePolicyArgs', 'ComputeInstanceGroupScalePolicyArgsDict']] scale_policy: The scaling policy of the instance group. > Either `fixed_scale` or `auto_scale` must be specified.
        :param pulumi.Input[builtins.str] service_account_id: [Service account](https://yandex.cloud/docs/iam/concepts/users/service-accounts) which linked to the resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] variables: A set of key/value variables pairs to assign to the instance group.
        """
        ...
    ...
    def get(resource_name: str,
            ...
            service_account_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'ComputeInstanceGroup':
        """
    ...
    @property
    @pulumi.getter(name="maxCheckingHealthDuration")
    def max_checking_health_duration(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Timeout for waiting for the VM to become healthy. If the timeout is exceeded, the VM will be turned off based on the
        deployment policy. Specified in seconds.
        """
