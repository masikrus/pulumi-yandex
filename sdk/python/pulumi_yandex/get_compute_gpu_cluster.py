...
def get_compute_gpu_cluster(folder_id: Optional[builtins.str] = None,
...
def get_compute_gpu_cluster_output(folder_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
