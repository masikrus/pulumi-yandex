...
class MdbPostgresqlClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] disk_encryption_key_id: ID of the KMS key used for cluster disk encryption. Encryption can`t be disabled for an existing cluster. If the source cluster is encrypted and you leave this field empty when restoring, the restored cluster will be created without encryption.
        ...
        :param pulumi.Input[_builtins.str] name: The name of PostgreSQL cluster.
