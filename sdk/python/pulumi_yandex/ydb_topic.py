...
class YdbTopicArgs:
    def __init__(__self__, *,
                 database_endpoint: pulumi.Input[builtins.str],
                 consumers: Optional[pulumi.Input[Sequence[pulumi.Input['YdbTopicConsumerArgs']]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 metering_mode: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 partition_write_speed_kbps: Optional[pulumi.Input[builtins.int]] = None,
                 partitions_count: Optional[pulumi.Input[builtins.int]] = None,
                 retention_period_hours: Optional[pulumi.Input[builtins.int]] = None,
                 retention_storage_mb: Optional[pulumi.Input[builtins.int]] = None,
                 supported_codecs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
    ...
    def database_endpoint(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "database_endpoint")

    @database_endpoint.setter
    def database_endpoint(self, value: pulumi.Input[builtins.str]):
    ...
    def metering_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "metering_mode")

    @metering_mode.setter
    def metering_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def partition_write_speed_kbps(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "partition_write_speed_kbps")

    @partition_write_speed_kbps.setter
    def partition_write_speed_kbps(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "partition_write_speed_kbps", value)

    @property
    @pulumi.getter(name="partitionsCount")
    def partitions_count(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "partitions_count")

    @partitions_count.setter
    def partitions_count(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def retention_storage_mb(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "retention_storage_mb")

    @retention_storage_mb.setter
    def retention_storage_mb(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "retention_storage_mb", value)

    @property
    @pulumi.getter(name="supportedCodecs")
    def supported_codecs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "supported_codecs")

    @supported_codecs.setter
    def supported_codecs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _YdbTopicState:
    def __init__(__self__, *,
                 consumers: Optional[pulumi.Input[Sequence[pulumi.Input['YdbTopicConsumerArgs']]]] = None,
                 database_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 metering_mode: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 partition_write_speed_kbps: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="databaseEndpoint")
    def database_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "database_endpoint")

    @database_endpoint.setter
    def database_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "database_endpoint", value)
...
class YdbTopic(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a YdbTopic resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            retention_period_hours: Optional[pulumi.Input[builtins.int]] = None,
            retention_storage_mb: Optional[pulumi.Input[builtins.int]] = None,
            supported_codecs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'YdbTopic':
        """
    ...
    @property
    @pulumi.getter(name="databaseEndpoint")
    def database_endpoint(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "database_endpoint")
    ...
    @property
    @pulumi.getter(name="meteringMode")
    def metering_mode(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "metering_mode")
    ...
    @property
    @pulumi.getter(name="partitionWriteSpeedKbps")
    def partition_write_speed_kbps(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "partition_write_speed_kbps")

    @property
    @pulumi.getter(name="partitionsCount")
    def partitions_count(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "partitions_count")

    @property
    @pulumi.getter(name="retentionPeriodHours")
    def retention_period_hours(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "retention_period_hours")

    @property
    @pulumi.getter(name="retentionStorageMb")
    def retention_storage_mb(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "retention_storage_mb")

    @property
    @pulumi.getter(name="supportedCodecs")
    def supported_codecs(self) -> pulumi.Output[Sequence[builtins.str]]:
        return pulumi.get(self, "supported_codecs")
