...
class FunctionTriggerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['FunctionTriggerContainerArgs'] container: [Yandex Cloud Serverless Container](https://yandex.cloud/docs/serverless-containers/concepts/container) settings
               definition for Yandex Cloud Functions Trigger.
        :param pulumi.Input['FunctionTriggerContainerRegistryArgs'] container_registry: [Container Registry](https://yandex.cloud/docs/functions/concepts/trigger/cr-trigger) settings definition for Yandex
               Cloud Functions Trigger, if present.
        :param pulumi.Input['FunctionTriggerDataStreamsArgs'] data_streams: [Data Streams](https://yandex.cloud/docs/functions/concepts/trigger/data-streams-trigger) settings definition for Yandex
               Cloud Functions Trigger, if present.
        ...
        :param pulumi.Input['FunctionTriggerFunctionArgs'] function: [Yandex Cloud Function](https://yandex.cloud/docs/functions/concepts/function) settings definition for Yandex Cloud
               Functions Trigger.
        :param pulumi.Input['FunctionTriggerIotArgs'] iot: [IoT](https://yandex.cloud/docs/functions/concepts/trigger/iot-core-trigger) settings definition for Yandex Cloud
        ...
        :param pulumi.Input['FunctionTriggerLoggingArgs'] logging: [Logging](https://yandex.cloud/docs/functions/concepts/trigger/cloud-logging-trigger) settings definition for Yandex
               Cloud Functions Trigger, if present.
        :param pulumi.Input['FunctionTriggerMailArgs'] mail: [Mail](https://yandex.cloud/docs/functions/concepts/trigger/mail-trigger) settings definition for Yandex Cloud Functions
               Trigger, if present.
        :param pulumi.Input['FunctionTriggerMessageQueueArgs'] message_queue: [Message Queue](https://yandex.cloud/docs/functions/concepts/trigger/ymq-trigger) settings definition for Yandex Cloud
               Functions Trigger, if present.
        :param pulumi.Input[builtins.str] name: The resource name.
        :param pulumi.Input['FunctionTriggerObjectStorageArgs'] object_storage: [Object Storage](https://yandex.cloud/docs/functions/concepts/trigger/os-trigger) settings definition for Yandex Cloud
               Functions Trigger, if present.
        :param pulumi.Input['FunctionTriggerTimerArgs'] timer: [Timer](https://yandex.cloud/docs/functions/concepts/trigger/timer) settings definition for Yandex Cloud Functions
               Trigger, if present.
        """
...
class FunctionTrigger(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['FunctionTriggerContainerArgs', 'FunctionTriggerContainerArgsDict']] container: [Yandex Cloud Serverless Container](https://yandex.cloud/docs/serverless-containers/concepts/container) settings
               definition for Yandex Cloud Functions Trigger.
        :param pulumi.Input[Union['FunctionTriggerContainerRegistryArgs', 'FunctionTriggerContainerRegistryArgsDict']] container_registry: [Container Registry](https://yandex.cloud/docs/functions/concepts/trigger/cr-trigger) settings definition for Yandex
               Cloud Functions Trigger, if present.
        :param pulumi.Input[Union['FunctionTriggerDataStreamsArgs', 'FunctionTriggerDataStreamsArgsDict']] data_streams: [Data Streams](https://yandex.cloud/docs/functions/concepts/trigger/data-streams-trigger) settings definition for Yandex
               Cloud Functions Trigger, if present.
        :param pulumi.Input[builtins.str] description: The resource description.
        ...
        :param pulumi.Input[builtins.str] folder_id: The folder identifier that resource belongs to. If it is not provided, the default provider `folder-id` is used.
        :param pulumi.Input[Union['FunctionTriggerFunctionArgs', 'FunctionTriggerFunctionArgsDict']] function: [Yandex Cloud Function](https://yandex.cloud/docs/functions/concepts/function) settings definition for Yandex Cloud
               Functions Trigger.
        :param pulumi.Input[Union['FunctionTriggerIotArgs', 'FunctionTriggerIotArgsDict']] iot: [IoT](https://yandex.cloud/docs/functions/concepts/trigger/iot-core-trigger) settings definition for Yandex Cloud
               Functions Trigger, if present. Only one section `iot` or `message_queue`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs which assigned to resource.
        :param pulumi.Input[Union['FunctionTriggerLoggingArgs', 'FunctionTriggerLoggingArgsDict']] logging: [Logging](https://yandex.cloud/docs/functions/concepts/trigger/cloud-logging-trigger) settings definition for Yandex
               Cloud Functions Trigger, if present.
        :param pulumi.Input[Union['FunctionTriggerMailArgs', 'FunctionTriggerMailArgsDict']] mail: [Mail](https://yandex.cloud/docs/functions/concepts/trigger/mail-trigger) settings definition for Yandex Cloud Functions
               Trigger, if present.
        :param pulumi.Input[Union['FunctionTriggerMessageQueueArgs', 'FunctionTriggerMessageQueueArgsDict']] message_queue: [Message Queue](https://yandex.cloud/docs/functions/concepts/trigger/ymq-trigger) settings definition for Yandex Cloud
               Functions Trigger, if present.
        :param pulumi.Input[builtins.str] name: The resource name.
        :param pulumi.Input[Union['FunctionTriggerObjectStorageArgs', 'FunctionTriggerObjectStorageArgsDict']] object_storage: [Object Storage](https://yandex.cloud/docs/functions/concepts/trigger/os-trigger) settings definition for Yandex Cloud
               Functions Trigger, if present.
        :param pulumi.Input[Union['FunctionTriggerTimerArgs', 'FunctionTriggerTimerArgsDict']] timer: [Timer](https://yandex.cloud/docs/functions/concepts/trigger/timer) settings definition for Yandex Cloud Functions
               Trigger, if present.
        """
        ...
    @overload
