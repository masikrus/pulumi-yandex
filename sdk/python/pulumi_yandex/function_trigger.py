...
class FunctionTriggerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['FunctionTriggerLogGroupArgs'] log_group: Deprecated Logging settings definition for Yandex Cloud Functions Trigger. Please, use logging instead.
...
class FunctionTrigger(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: A set of key/value label pairs which assigned to resource.
        :param pulumi.Input[Union['FunctionTriggerLogGroupArgs', 'FunctionTriggerLogGroupArgsDict']] log_group: Deprecated Logging settings definition for Yandex Cloud Functions Trigger. Please, use logging instead.
