...
class ContainerRepositoryLifecyclePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] repository_id: The ID of the repository that the resource belongs to.
        :param pulumi.Input[builtins.str] status: The status of lifecycle policy. Must be `active` or `disabled`.
...
class ContainerRepositoryLifecyclePolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ContainerRepositoryLifecyclePolicy resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            repository_id: Optional[pulumi.Input[builtins.str]] = None,
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ContainerRepositoryLifecyclePolicyRuleArgs', 'ContainerRepositoryLifecyclePolicyRuleArgsDict']]]]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'ContainerRepositoryLifecyclePolicy':
        """
