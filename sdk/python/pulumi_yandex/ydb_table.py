...
class YdbTableArgs:
    def __init__(__self__, *,
                 ...
                 primary_keys: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 ...
                 key_bloom_filter: Optional[pulumi.Input[builtins.bool]] = None,
                 partitioning_settings: Optional[pulumi.Input['YdbTablePartitioningSettingsArgs']] = None,
                 read_replicas_settings: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def primary_keys(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        return pulumi.get(self, "primary_keys")

    @primary_keys.setter
    def primary_keys(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def key_bloom_filter(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "key_bloom_filter")

    @key_bloom_filter.setter
    def key_bloom_filter(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def read_replicas_settings(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "read_replicas_settings")

    @read_replicas_settings.setter
    def read_replicas_settings(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _YdbTableState:
    ...
    @property
    @pulumi.getter(name="primaryKeys")
    def primary_keys(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "primary_keys")

    @primary_keys.setter
    def primary_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "primary_keys", value)
...
class YdbTable(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a YdbTable resource with the given unique name, props, and options.
    ...
    @property
    @pulumi.getter(name="keyBloomFilter")
    def key_bloom_filter(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "key_bloom_filter")
    ...
    @property
    @pulumi.getter(name="primaryKeys")
    def primary_keys(self) -> pulumi.Output[Sequence[builtins.str]]:
        return pulumi.get(self, "primary_keys")

    @property
    @pulumi.getter(name="readReplicasSettings")
    def read_replicas_settings(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "read_replicas_settings")
