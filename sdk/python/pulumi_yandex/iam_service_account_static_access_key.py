...
class IamServiceAccountStaticAccessKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] service_account_id: ID of the service account which is used to get a static key.
...
class _IamServiceAccountStaticAccessKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_key: ID of the static access key. This is only populated when `output_to_lockbox` is not provided.
        :param pulumi.Input[builtins.str] created_at: The creation timestamp of the resource.
        :param pulumi.Input[builtins.str] description: The resource description.
        :param pulumi.Input[builtins.str] encrypted_secret_key: The encrypted secret, base64 encoded. This is only populated when `pgp_key` is supplied.
        ...
        :param pulumi.Input[builtins.str] pgp_key: An optional PGP key to encrypt the resulting secret key material. May either be a base64-encoded public key or a keybase
               username in the form `keybase:keybaseusername`.
        :param pulumi.Input[builtins.str] secret_key: Private part of generated static access key. This is only populated when neither `pgp_key` nor `output_to_lockbox` are
               provided.
        :param pulumi.Input[builtins.str] service_account_id: ID of the service account which is used to get a static key.
        """
...
class IamServiceAccountStaticAccessKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            pgp_key: Optional[pulumi.Input[builtins.str]] = None,
            secret_key: Optional[pulumi.Input[builtins.str]] = None,
            service_account_id: Optional[pulumi.Input[builtins.str]] = None) -> 'IamServiceAccountStaticAccessKey':
        """
