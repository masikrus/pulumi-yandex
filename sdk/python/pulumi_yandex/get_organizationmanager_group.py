...
def get_organizationmanager_group(group_id: Optional[builtins.str] = None,
...
def get_organizationmanager_group_output(group_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
