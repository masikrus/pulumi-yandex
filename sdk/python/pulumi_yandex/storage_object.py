...
class StorageObjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bucket: The name of the containing bucket.
        ...
        :param pulumi.Input[builtins.str] content: Literal string value to use as the object content, which will be uploaded as UTF-8-encoded text. Conflicts with `source`
               and `content_base64`.
        :param pulumi.Input[builtins.str] content_base64: Base64-encoded data that will be decoded and uploaded as raw bytes for the object content. This allows safely uploading
               ...
               `content`.
        :param pulumi.Input[builtins.str] content_type: A standard MIME type describing the format of the object data, e.g. `application/octet-stream`. All Valid MIME Types are
               valid for this input.
        :param pulumi.Input[builtins.str] object_lock_legal_hold_status: Specifies a [legal hold status](https://yandex.cloud/docs/storage/concepts/object-lock#types) of an object. Requires
               `object_lock_configuration` to be enabled on a bucket.
        :param pulumi.Input[builtins.str] object_lock_mode: Specifies a type of object lock. One of `["GOVERNANCE", "COMPLIANCE"]`. It must be set simultaneously with
               `object_lock_retain_until_date`. Requires `object_lock_configuration` to be enabled on a bucket.
        :param pulumi.Input[builtins.str] object_lock_retain_until_date: Specifies date and time in RTC3339 format until which an object is to be locked. It must be set simultaneously with
        ...
        :param pulumi.Input[builtins.str] secret_key: The secret key to use when applying changes. This value can also be provided as `storage_secret_key` specified in
               provider config (explicitly or within `shared_credentials_file`) is used.
        :param pulumi.Input[builtins.str] source: The path to a file that will be read and uploaded as raw bytes for the object content. Conflicts with `content` and
               `content_base64`.
        :param pulumi.Input[builtins.str] source_hash: Used to trigger object update when the source content changes. So the only meaningful value is
...
@pulumi.type_token("yandex:index/storageObject:StorageObject")
class StorageObject(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source: Optional[pulumi.Input[builtins.str]] = None,
            source_hash: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'StorageObject':
        """
