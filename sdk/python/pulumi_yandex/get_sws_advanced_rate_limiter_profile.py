...
class GetSwsAdvancedRateLimiterProfileResult:
    ...
    def advanced_rate_limiter_profile_id(self) -> Optional[builtins.str]:
...
def get_sws_advanced_rate_limiter_profile(advanced_rate_limiter_profile_id: Optional[builtins.str] = None,
...
def get_sws_advanced_rate_limiter_profile_output(advanced_rate_limiter_profile_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
