...
class KmsAsymmetricEncryptionKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] encryption_algorithm: Encryption algorithm to be used with a new key. The default value is `RSA_2048_ENC_OAEP_SHA_256`.
...
class KmsAsymmetricEncryptionKey(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a KmsAsymmetricEncryptionKey resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'KmsAsymmetricEncryptionKey':
        """
    ...
    @property
    @pulumi.getter(name="encryptionAlgorithm")
    def encryption_algorithm(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Encryption algorithm to be used with a new key. The default value is `RSA_2048_ENC_OAEP_SHA_256`.
        """
        return pulumi.get(self, "encryption_algorithm")
