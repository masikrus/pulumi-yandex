...
class DatatransferTransferArgs:
    def __init__(__self__, *,
                 ...
                 on_create_activate_mode: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] on_create_activate_mode: Activation action on create a new incremental transfer. It is not part of the transfer parameter and is used only on
        ...
        :param pulumi.Input[builtins.str] source_id: ID of the source endpoint for the transfer.
        :param pulumi.Input[builtins.str] target_id: ID of the target endpoint for the transfer.
        :param pulumi.Input['DatatransferTransferTransformationArgs'] transformation: Transformation for the transfer.
        :param pulumi.Input[builtins.str] type: Type of the transfer. One of `SNAPSHOT_ONLY`, `INCREMENT_ONLY`, `SNAPSHOT_AND_INCREMENT`
        """
    ...
    def on_create_activate_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def on_create_activate_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DatatransferTransferState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['DatatransferTransferTransformationArgs'] transformation: Transformation for the transfer.
        :param pulumi.Input[builtins.str] type: Type of the transfer. One of `SNAPSHOT_ONLY`, `INCREMENT_ONLY`, `SNAPSHOT_AND_INCREMENT`
        :param pulumi.Input[builtins.str] warning: Error description if transfer has any errors.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if folder_id is not None:
...
class DatatransferTransfer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            transformation: Optional[pulumi.Input[Union['DatatransferTransferTransformationArgs', 'DatatransferTransferTransformationArgsDict']]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            warning: Optional[pulumi.Input[builtins.str]] = None) -> 'DatatransferTransfer':
        """
    ...
    @property
    @pulumi.getter(name="onCreateActivateMode")
    def on_create_activate_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Activation action on create a new incremental transfer. It is not part of the transfer parameter and is used only on
        create. One of `sync_activate`, `async_activate`, `dont_activate`. The default is `sync_activate`.
        """
    ...
    @property
    @pulumi.getter
    def warning(self) -> pulumi.Output[builtins.str]:
        """
        Error description if transfer has any errors.
        """
        return pulumi.get(self, "warning")
