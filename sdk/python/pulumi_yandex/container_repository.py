...
class ContainerRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: A name of the repository. The name of the repository should start with id of a container registry and match the name of
    ...
    def name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A name of the repository. The name of the repository should start with id of a container registry and match the name of
        the images that will be pushed in the repository.
        """
...
class ContainerRepository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'ContainerRepository':
        """
