...
class ComputeDiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] block_size: Block size of the disk, specified in bytes.
        ...
        :param pulumi.Input['ComputeDiskHardwareGenerationArgs'] hardware_generation: Hardware generation and its features, which will be applied to the instance when this disk is used as a boot disk.
               Provide this property if you wish to override this value, which otherwise is inherited from the source.
        :param pulumi.Input[builtins.str] image_id: The source image to use for disk creation.
        :param pulumi.Input[builtins.str] kms_key_id: ID of KMS symmetric key used to encrypt disk.
        ...
        :param pulumi.Input[builtins.int] size: Size of the persistent disk, specified in GB. You can specify this field when creating a persistent disk using the
               ...
               the snapshot.
        :param pulumi.Input[builtins.str] snapshot_id: The source snapshot to use for disk creation.
        :param pulumi.Input[builtins.str] type: Type of disk to create. Provide this when creating a disk.
...
class ComputeDisk(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] folder_id: The folder identifier that resource belongs to. If it is not provided, the default provider `folder-id` is used.
        :param pulumi.Input[Union['ComputeDiskHardwareGenerationArgs', 'ComputeDiskHardwareGenerationArgsDict']] hardware_generation: Hardware generation and its features, which will be applied to the instance when this disk is used as a boot disk.
               Provide this property if you wish to override this value, which otherwise is inherited from the source.
        :param pulumi.Input[builtins.str] image_id: The source image to use for disk creation.
        :param pulumi.Input[builtins.str] kms_key_id: ID of KMS symmetric key used to encrypt disk.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs which assigned to resource.
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'ComputeDisk':
        """
