...
def get_function_scaling_policy(function_id: Optional[builtins.str] = None,
...
def get_function_scaling_policy_output(function_id: Optional[pulumi.Input[builtins.str]] = None,
