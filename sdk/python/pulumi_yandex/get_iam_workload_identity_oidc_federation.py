...
def get_iam_workload_identity_oidc_federation(federation_id: Optional[builtins.str] = None,
...
def get_iam_workload_identity_oidc_federation_output(federation_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
