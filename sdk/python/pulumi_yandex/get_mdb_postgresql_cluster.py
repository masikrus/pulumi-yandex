...
def get_mdb_postgresql_cluster(cluster_id: Optional[builtins.str] = None,
...
def get_mdb_postgresql_cluster_output(cluster_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
