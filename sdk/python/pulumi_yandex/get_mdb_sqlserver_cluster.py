...
class GetMdbSqlserverClusterResult:
    ...
    def host_group_ids(self) -> Sequence[builtins.str]:
    ...
    @property
    @pulumi.getter
    def sqlcollation(self) -> builtins.str:
        return pulumi.get(self, "sqlcollation")

    @property
    @pulumi.getter(name="sqlserverConfig")
    def sqlserver_config(self) -> Mapping[str, builtins.str]:
...
def get_mdb_sqlserver_cluster(cluster_id: Optional[builtins.str] = None,
                              deletion_protection: Optional[builtins.bool] = None,
                              folder_id: Optional[builtins.str] = None,
                              name: Optional[builtins.str] = None,
                              sqlcollation: Optional[builtins.str] = None,
                              sqlserver_config: Optional[Mapping[str, builtins.str]] = None,
...
def get_mdb_sqlserver_cluster_output(cluster_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     ...
                                     sqlcollation: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     sqlserver_config: Optional[pulumi.Input[Optional[Mapping[str, builtins.str]]]] = None,
