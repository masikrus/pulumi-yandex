...
class GetCmCertificateContentResult:
    ...
    def private_key_format(self) -> Optional[builtins.str]:
        return pulumi.get(self, "private_key_format")

    @property
    @pulumi.getter(name="waitValidation")
    def wait_validation(self) -> Optional[builtins.bool]:
...
def get_cm_certificate_content(certificate_id: Optional[builtins.str] = None,
                               folder_id: Optional[builtins.str] = None,
                               name: Optional[builtins.str] = None,
                               private_key_format: Optional[builtins.str] = None,
                               wait_validation: Optional[builtins.bool] = None,
...
def get_cm_certificate_content_output(certificate_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                      folder_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                      name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                      private_key_format: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                      wait_validation: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
