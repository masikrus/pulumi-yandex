...
def get_container_registry(folder_id: Optional[_builtins.str] = None,
...
def get_container_registry_output(folder_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
