...
def get_container_registry(folder_id: Optional[builtins.str] = None,
...
def get_container_registry_output(folder_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
