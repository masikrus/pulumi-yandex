...
class GetMdbMysqlUserResult:
    ...
    def authentication_plugin(self) -> builtins.str:
    ...
    def global_permissions(self) -> Sequence[builtins.str]:
...
def get_mdb_mysql_user(cluster_id: Optional[builtins.str] = None,
...
def get_mdb_mysql_user_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
