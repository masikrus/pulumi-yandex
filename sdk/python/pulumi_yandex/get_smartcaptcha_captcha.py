...
class GetSmartcaptchaCaptchaResult:
    ...
    def pre_check_type(self) -> builtins.str:
    ...
    def style_json(self) -> builtins.str:
    ...
    def turn_off_hostname_check(self) -> builtins.bool:
...
def get_smartcaptcha_captcha(captcha_id: Optional[builtins.str] = None,
...
def get_smartcaptcha_captcha_output(captcha_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    cloud_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
