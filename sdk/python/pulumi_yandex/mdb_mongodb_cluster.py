...
class MdbMongodbClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] environment: Deployment environment of the MongoDB cluster. Can be either `PRESTABLE` or `PRODUCTION`.
        ...
        :param pulumi.Input[builtins.str] cluster_id: The ID of the cluster.
...
class _MdbMongodbClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['MdbMongodbClusterRestoreArgs'] restore: The cluster will be created from the specified backup.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: The list of security groups applied to resource or their components.
        :param pulumi.Input[builtins.bool] sharded: MongoDB Cluster mode enabled/disabled.
...
class MdbMongodbCluster(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def sharded(self) -> pulumi.Output[builtins.bool]:
        """
        MongoDB Cluster mode enabled/disabled.
        """
        return pulumi.get(self, "sharded")
