...
class GetComputeInstanceGroupResult:
    ...
    def max_checking_health_duration(self) -> builtins.int:
...
def get_compute_instance_group(instance_group_id: Optional[builtins.str] = None,
...
def get_compute_instance_group_output(instance_group_id: Optional[pulumi.Input[builtins.str]] = None,
