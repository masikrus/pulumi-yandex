...
class MdbClickhouseClusterArgs:
    def __init__(__self__, *,
                 ...
                 copy_schema_on_new_hosts: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 embedded_keeper: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 sql_database_management: Optional[pulumi.Input[builtins.bool]] = None,
                 sql_user_management: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] environment: Deployment environment of the ClickHouse cluster. Can be either `PRESTABLE` or `PRODUCTION`.
        ...
        :param pulumi.Input[builtins.str] admin_password: A password used to authorize as user `admin` when `sql_user_management` enabled.
        ...
        :param pulumi.Input[builtins.str] cluster_id: The cluster identifier.
        :param pulumi.Input[builtins.bool] copy_schema_on_new_hosts: Whether to copy schema on new ClickHouse hosts.
        ...
        :param pulumi.Input[builtins.bool] embedded_keeper: Whether to use ClickHouse Keeper as a coordination system and place it on the same hosts with ClickHouse. If not, it's
        ...
        :param pulumi.Input[builtins.bool] sql_database_management: Grants `admin` user database management permission.
        :param pulumi.Input[builtins.bool] sql_user_management: Enables `admin` user with user management permission.
        :param pulumi.Input[Sequence[pulumi.Input['MdbClickhouseClusterUserArgs']]] users: A user of the ClickHouse cluster.
        :param pulumi.Input[builtins.str] version: Version of the ClickHouse server software.
    ...
    def copy_schema_on_new_hosts(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def copy_schema_on_new_hosts(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def embedded_keeper(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def embedded_keeper(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def sql_database_management(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def sql_database_management(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "sql_database_management", value)

    @property
    @pulumi.getter(name="sqlUserManagement")
    def sql_user_management(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def sql_user_management(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _MdbClickhouseClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] folder_id: The folder identifier that resource belongs to. If it is not provided, the default provider `folder-id` is used.
        :param pulumi.Input[Sequence[pulumi.Input['MdbClickhouseClusterFormatSchemaArgs']]] format_schemas: A set of `protobuf` or `capnproto` format schemas.
        :param pulumi.Input[builtins.str] health: Aggregated health of the cluster. Can be `ALIVE`, `DEGRADED`, `DEAD` or `HEALTH_UNKNOWN`. For more information see
        ...
        :param pulumi.Input[builtins.bool] sql_database_management: Grants `admin` user database management permission.
        :param pulumi.Input[builtins.bool] sql_user_management: Enables `admin` user with user management permission.
        :param pulumi.Input[builtins.str] status: Status of the cluster. Can be `CREATING`, `STARTING`, `RUNNING`, `UPDATING`, `STOPPING`, `STOPPED`, `ERROR` or
...
class MdbClickhouseCluster(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="backupRetainPeriodDays")
    def backup_retain_period_days(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The period in days during which backups are stored.
        """
        return pulumi.get(self, "backup_retain_period_days")
    ...
    @property
    @pulumi.getter(name="copySchemaOnNewHosts")
    def copy_schema_on_new_hosts(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to copy schema on new ClickHouse hosts.
        """
        return pulumi.get(self, "copy_schema_on_new_hosts")
    ...
    @property
    @pulumi.getter(name="embeddedKeeper")
    def embedded_keeper(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to use ClickHouse Keeper as a coordination system and place it on the same hosts with ClickHouse. If not, it's
        used ZooKeeper with placement on separate hosts.
        """
    ...
    @property
    @pulumi.getter(name="sqlDatabaseManagement")
    def sql_database_management(self) -> pulumi.Output[builtins.bool]:
        """
        Grants `admin` user database management permission.
        """
        return pulumi.get(self, "sql_database_management")
    ...
    @property
    @pulumi.getter(name="sqlUserManagement")
    def sql_user_management(self) -> pulumi.Output[builtins.bool]:
        """
        Enables `admin` user with user management permission.
        """
        return pulumi.get(self, "sql_user_management")
