...
def get_vpc_security_group(folder_id: Optional[builtins.str] = None,
...
def get_vpc_security_group_output(folder_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
