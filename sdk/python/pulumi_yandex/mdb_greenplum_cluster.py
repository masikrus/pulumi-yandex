...
class MdbGreenplumClusterArgs:
    def __init__(__self__, *,
                 assign_public_ip: pulumi.Input[builtins.bool],
                 environment: pulumi.Input[builtins.str],
                 master_host_count: pulumi.Input[builtins.int],
                 master_subcluster: pulumi.Input['MdbGreenplumClusterMasterSubclusterArgs'],
                 network_id: pulumi.Input[builtins.str],
                 segment_host_count: pulumi.Input[builtins.int],
                 segment_in_host: pulumi.Input[builtins.int],
                 ...
                 greenplum_config: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 ...
                 master_host_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 segment_host_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.bool] assign_public_ip: Sets whether the master hosts should get a public IP address on creation. Changing this parameter for an existing host
               is not supported at the moment.
        :param pulumi.Input[builtins.str] environment: Deployment environment of the Greenplum cluster. (PRODUCTION, PRESTABLE)
        :param pulumi.Input[builtins.int] master_host_count: Number of hosts in master subcluster (1 or 2).
        ...
        :param pulumi.Input[builtins.int] segment_host_count: Number of hosts in segment subcluster (from 1 to 32).
        :param pulumi.Input[builtins.int] segment_in_host: Number of segments on segment host (not more then 1 + RAM/8).
        :param pulumi.Input['MdbGreenplumClusterSegmentSubclusterArgs'] segment_subcluster: Settings for segment subcluster.
        :param pulumi.Input[builtins.str] subnet_id: The ID of the subnet, to which the hosts belongs. The subnet must be a part of the network to which the cluster belongs.
        :param pulumi.Input[builtins.str] user_name: Greenplum cluster admin user name.
        :param pulumi.Input[builtins.str] user_password: Greenplum cluster admin password name.
        :param pulumi.Input[builtins.str] version: Version of the Greenplum cluster. (`6.25`)
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] greenplum_config: Greenplum cluster config. Detail info in `Greenplum cluster settings` block.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] master_host_group_ids: A list of IDs of the host groups to place master subclusters' VMs of the cluster on.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] segment_host_group_ids: A list of IDs of the host groups to place segment subclusters' VMs of the cluster on.
        :param pulumi.Input[builtins.str] service_account_id: ID of service account to use with Yandex Cloud resources (e.g. S3, Cloud Logging).
        """
    ...
    def assign_public_ip(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def assign_public_ip(self, value: pulumi.Input[builtins.bool]):
    ...
    def master_host_count(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def master_host_count(self, value: pulumi.Input[builtins.int]):
    ...
    def segment_host_count(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def segment_host_count(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "segment_host_count", value)

    @property
    @pulumi.getter(name="segmentInHost")
    def segment_in_host(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def segment_in_host(self, value: pulumi.Input[builtins.int]):
    ...
    def greenplum_config(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def greenplum_config(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def master_host_group_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def master_host_group_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def segment_host_group_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def segment_host_group_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _MdbGreenplumClusterState:
    def __init__(__self__, *,
                 ...
                 logging: Optional[pulumi.Input['MdbGreenplumClusterLoggingArgs']] = None,
                 maintenance_window: Optional[pulumi.Input['MdbGreenplumClusterMaintenanceWindowArgs']] = None,
                 master_host_count: Optional[pulumi.Input[builtins.int]] = None,
                 master_host_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 pxf_config: Optional[pulumi.Input['MdbGreenplumClusterPxfConfigArgs']] = None,
                 security_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 segment_host_count: Optional[pulumi.Input[builtins.int]] = None,
                 segment_host_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 segment_hosts: Optional[pulumi.Input[Sequence[pulumi.Input['MdbGreenplumClusterSegmentHostArgs']]]] = None,
                 segment_in_host: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="masterHostCount")
    def master_host_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of hosts in master subcluster (1 or 2).
        """
        return pulumi.get(self, "master_host_count")
    ...
    @master_host_count.setter
    def master_host_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "master_host_count", value)
    ...
    @property
    @pulumi.getter(name="segmentHostCount")
    def segment_host_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of hosts in segment subcluster (from 1 to 32).
        """
        return pulumi.get(self, "segment_host_count")
    ...
    @segment_host_count.setter
    def segment_host_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "segment_host_count", value)
    ...
    @property
    @pulumi.getter(name="segmentInHost")
    def segment_in_host(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of segments on segment host (not more then 1 + RAM/8).
        """
        return pulumi.get(self, "segment_in_host")
    ...
    @segment_in_host.setter
    def segment_in_host(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "segment_in_host", value)
...
class MdbGreenplumCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            user_password: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'MdbGreenplumCluster':
        """
    ...
    @property
    @pulumi.getter(name="assignPublicIp")
    def assign_public_ip(self) -> pulumi.Output[builtins.bool]:
        """
        Sets whether the master hosts should get a public IP address on creation. Changing this parameter for an existing host
        is not supported at the moment.
        """
    ...
    @property
    @pulumi.getter(name="greenplumConfig")
    def greenplum_config(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        Greenplum cluster config. Detail info in `Greenplum cluster settings` block.
        """
        return pulumi.get(self, "greenplum_config")
    ...
    @property
    @pulumi.getter(name="masterHostCount")
    def master_host_count(self) -> pulumi.Output[builtins.int]:
        """
        Number of hosts in master subcluster (1 or 2).
        """
        return pulumi.get(self, "master_host_count")
    ...
    @property
    @pulumi.getter(name="masterHostGroupIds")
    def master_host_group_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of IDs of the host groups to place master subclusters' VMs of the cluster on.
        """
        return pulumi.get(self, "master_host_group_ids")
    ...
    @property
    @pulumi.getter(name="segmentHostCount")
    def segment_host_count(self) -> pulumi.Output[builtins.int]:
        """
        Number of hosts in segment subcluster (from 1 to 32).
        """
        return pulumi.get(self, "segment_host_count")
    ...
    @property
    @pulumi.getter(name="segmentHostGroupIds")
    def segment_host_group_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of IDs of the host groups to place segment subclusters' VMs of the cluster on.
        """
        return pulumi.get(self, "segment_host_group_ids")
    ...
    @property
    @pulumi.getter(name="segmentInHost")
    def segment_in_host(self) -> pulumi.Output[builtins.int]:
        """
        Number of segments on segment host (not more then 1 + RAM/8).
        """
        return pulumi.get(self, "segment_in_host")
