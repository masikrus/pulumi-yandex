...
class IamServiceAccountIamPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy_data: Required only by `IamServiceAccountIamPolicy`. The policy data generated by a `get_iam_policy` data source.
...
class IamServiceAccountIamPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            policy_data: Optional[pulumi.Input[builtins.str]] = None,
            service_account_id: Optional[pulumi.Input[builtins.str]] = None) -> 'IamServiceAccountIamPolicy':
        """
