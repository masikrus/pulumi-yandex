...
class GetCdnOriginGroupResult:
    ...
    def origin_group_id(self) -> builtins.int:
    ...
    def use_next(self) -> builtins.bool:
...
def get_cdn_origin_group(folder_id: Optional[builtins.str] = None,
...
def get_cdn_origin_group_output(folder_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
