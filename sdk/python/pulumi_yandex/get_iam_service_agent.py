...
class GetIamServiceAgentResult:
    ...
    def microservice_id(self) -> builtins.str:
...
def get_iam_service_agent(cloud_id: Optional[builtins.str] = None,
                          microservice_id: Optional[builtins.str] = None,
...
def get_iam_service_agent_output(cloud_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 microservice_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
