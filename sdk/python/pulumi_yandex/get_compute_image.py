...
def get_compute_image(family: Optional[builtins.str] = None,
...
def get_compute_image_output(family: Optional[pulumi.Input[Optional[builtins.str]]] = None,
