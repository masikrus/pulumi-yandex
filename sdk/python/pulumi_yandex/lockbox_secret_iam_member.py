...
@pulumi.type_token("yandex:index/lockboxSecretIamMember:LockboxSecretIamMember")
class LockboxSecretIamMember(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a LockboxSecretIamMember resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            role: Optional[pulumi.Input[builtins.str]] = None,
            secret_id: Optional[pulumi.Input[builtins.str]] = None,
            sleep_after: Optional[pulumi.Input[builtins.int]] = None) -> 'LockboxSecretIamMember':
        """
