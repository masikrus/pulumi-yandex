...
class KmsSymmetricKeyArgs:
    def __init__(__self__, *,
                 default_algorithm: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] default_algorithm: Encryption algorithm to be used with a new key version, generated with the next rotation. The default value is
               `AES_128`.
        ...
        :param pulumi.Input[builtins.str] rotation_period: Interval between automatic rotations. To disable automatic rotation, omit this parameter.
        """
    ...
    def default_algorithm(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_algorithm(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _KmsSymmetricKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs which assigned to resource.
        :param pulumi.Input[builtins.str] name: The resource name.
        :param pulumi.Input[builtins.str] rotated_at: Last rotation timestamp of the key.
        :param pulumi.Input[builtins.str] rotation_period: Interval between automatic rotations. To disable automatic rotation, omit this parameter.
        :param pulumi.Input[builtins.str] status: The status of the key.
        """
...
class KmsSymmetricKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rotated_at: Optional[pulumi.Input[builtins.str]] = None,
            rotation_period: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'KmsSymmetricKey':
        """
    ...
    @property
    @pulumi.getter(name="defaultAlgorithm")
    def default_algorithm(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Encryption algorithm to be used with a new key version, generated with the next rotation. The default value is
        `AES_128`.
        """
