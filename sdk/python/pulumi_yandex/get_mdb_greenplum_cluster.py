...
class GetMdbGreenplumClusterResult:
    ...
    def greenplum_config(self) -> Mapping[str, builtins.str]:
    ...
    def master_host_count(self) -> builtins.int:
        return pulumi.get(self, "master_host_count")

    @property
    @pulumi.getter(name="masterHostGroupIds")
    def master_host_group_ids(self) -> Sequence[builtins.str]:
    ...
    def segment_host_count(self) -> builtins.int:
        return pulumi.get(self, "segment_host_count")

    @property
    @pulumi.getter(name="segmentHostGroupIds")
    def segment_host_group_ids(self) -> Sequence[builtins.str]:
    ...
    def segment_in_host(self) -> builtins.int:
...
def get_mdb_greenplum_cluster(background_activities: Optional[Sequence[Union['GetMdbGreenplumClusterBackgroundActivityArgs', 'GetMdbGreenplumClusterBackgroundActivityArgsDict']]] = None,
                              ...
                              greenplum_config: Optional[Mapping[str, builtins.str]] = None,
                              master_host_group_ids: Optional[Sequence[builtins.str]] = None,
                              ...
                              segment_host_group_ids: Optional[Sequence[builtins.str]] = None,
...
def get_mdb_greenplum_cluster_output(background_activities: Optional[pulumi.Input[Optional[Sequence[Union['GetMdbGreenplumClusterBackgroundActivityArgs', 'GetMdbGreenplumClusterBackgroundActivityArgsDict']]]]] = None,
                                     ...
                                     greenplum_config: Optional[pulumi.Input[Optional[Mapping[str, builtins.str]]]] = None,
                                     master_host_group_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                     ...
                                     segment_host_group_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
