...
class GetServerlessEventrouterRuleResult:
    ...
    def jq_filter(self) -> builtins.str:
...
def get_serverless_eventrouter_rule(name: Optional[builtins.str] = None,
...
def get_serverless_eventrouter_rule_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
