...
class MdbSqlserverClusterArgs:
    def __init__(__self__, *,
                 ...
                 sqlcollation: Optional[pulumi.Input[builtins.str]] = None,
                 sqlserver_config: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] environment: Deployment environment of the SQLServer cluster. (PRODUCTION, PRESTABLE).
        ...
        :param pulumi.Input[builtins.str] version: Version of the SQLServer cluster. (2016sp2std, 2016sp2ent).
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] host_group_ids: A list of IDs of the host groups hosting VMs of the cluster.
        ...
        :param pulumi.Input[builtins.str] sqlcollation: SQL Collation cluster will be created with. This attribute cannot be changed when cluster is created!
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] sqlserver_config: SQLServer cluster config. Detail info in `SQLServer config` section.
        """
    ...
    @property
    @pulumi.getter
    def sqlcollation(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sqlcollation.setter
    def sqlcollation(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sqlcollation", value)

    @property
    @pulumi.getter(name="sqlserverConfig")
    def sqlserver_config(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def sqlserver_config(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class MdbSqlserverCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            users: Optional[pulumi.Input[Sequence[pulumi.Input[Union['MdbSqlserverClusterUserArgs', 'MdbSqlserverClusterUserArgsDict']]]]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'MdbSqlserverCluster':
        """
    ...
    @property
    @pulumi.getter
    def sqlcollation(self) -> pulumi.Output[builtins.str]:
        """
        SQL Collation cluster will be created with. This attribute cannot be changed when cluster is created!
        """
        return pulumi.get(self, "sqlcollation")
    ...
    @property
    @pulumi.getter(name="sqlserverConfig")
    def sqlserver_config(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        SQLServer cluster config. Detail info in `SQLServer config` section.
        """
        return pulumi.get(self, "sqlserver_config")
