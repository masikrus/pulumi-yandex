...
class GetDataprocClusterResult:
    ...
    def ui_proxy(self) -> builtins.bool:
...
def get_dataproc_cluster(cluster_id: Optional[builtins.str] = None,
...
def get_dataproc_cluster_output(cluster_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
