...
class IamWorkloadIdentityOidcFederationArgs:
    def __init__(__self__, *,
                 ...
                 jwks_url: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] issuer: Issuer identifier of the external IdP server to be used for authentication.
        :param pulumi.Input[builtins.str] jwks_url: URL reference to trusted keys in format of JSON Web Key Set.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] audiences: List of trusted values for aud claim.
        :param pulumi.Input[builtins.str] description: Description of the OIDC workload identity federation.
        :param pulumi.Input[builtins.bool] disabled: Disabled flag.
        :param pulumi.Input[builtins.str] federation_id: Id of the OIDC workload identity federation.
        :param pulumi.Input[builtins.str] folder_id: Id of the folder that the OIDC workload identity federation belongs to.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Resource labels as key-value pairs.
        :param pulumi.Input[builtins.str] name: Name of the OIDC workload identity federation. The name is unique within the folder.
        """
    ...
    def jwks_url(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @jwks_url.setter
    def jwks_url(self, value: pulumi.Input[builtins.str]):
...
class _IamWorkloadIdentityOidcFederationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] audiences: List of trusted values for aud claim.
        :param pulumi.Input[builtins.str] created_at: Creation timestamp.
        :param pulumi.Input[builtins.str] description: Description of the OIDC workload identity federation.
        :param pulumi.Input[builtins.bool] disabled: Disabled flag.
...
class IamWorkloadIdentityOidcFederation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a IamWorkloadIdentityOidcFederation resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            jwks_url: Optional[pulumi.Input[builtins.str]] = None,
            labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'IamWorkloadIdentityOidcFederation':
        """
    ...
    @property
    @pulumi.getter(name="jwksUrl")
    def jwks_url(self) -> pulumi.Output[builtins.str]:
        """
        URL reference to trusted keys in format of JSON Web Key Set.
        """
        return pulumi.get(self, "jwks_url")
