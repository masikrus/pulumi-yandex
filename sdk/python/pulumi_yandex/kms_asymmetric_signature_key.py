...
class KmsAsymmetricSignatureKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] signature_algorithm: Signature algorithm to be used with a new key. The default value is `RSA_2048_SIGN_PSS_SHA_256`.
        """
...
class KmsAsymmetricSignatureKey(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a KmsAsymmetricSignatureKey resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            signature_algorithm: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'KmsAsymmetricSignatureKey':
        """
