...
class StorageBucketArgs:
    def __init__(__self__, *,
                 ...
                 disabled_statickey_auth: Optional[pulumi.Input[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.str] bucket: The name of the bucket. If omitted, Terraform will assign a random, unique name.
        ...
        :param pulumi.Input[_builtins.bool] disabled_statickey_auth: If true, static key authentication in bucket is forbidden. Default is `false`.
        ...
        if disabled_statickey_auth is not None:
            pulumi.set(__self__, "disabled_statickey_auth", disabled_statickey_auth)
    ...
    @_builtins.property
    @pulumi.getter(name="disabledStatickeyAuth")
    def disabled_statickey_auth(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        If true, static key authentication in bucket is forbidden. Default is `false`.
        """
        return pulumi.get(self, "disabled_statickey_auth")

    @disabled_statickey_auth.setter
    def disabled_statickey_auth(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "disabled_statickey_auth", value)
...
class StorageBucket(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["disabled_statickey_auth"] = disabled_statickey_auth
    ...
    @_builtins.property
    @pulumi.getter(name="disabledStatickeyAuth")
    def disabled_statickey_auth(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        If true, static key authentication in bucket is forbidden. Default is `false`.
        """
        return pulumi.get(self, "disabled_statickey_auth")
