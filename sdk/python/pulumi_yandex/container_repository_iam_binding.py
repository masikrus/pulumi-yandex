...
class ContainerRepositoryIamBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] repository_id: The [Yandex Container Repository](https://yandex.cloud/docs/container-registry/concepts/repository) ID to apply a
               binding to.
...
@pulumi.type_token("yandex:index/containerRepositoryIamBinding:ContainerRepositoryIamBinding")
class ContainerRepositoryIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ContainerRepositoryIamBinding resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            repository_id: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None,
            sleep_after: Optional[pulumi.Input[builtins.int]] = None) -> 'ContainerRepositoryIamBinding':
        """
