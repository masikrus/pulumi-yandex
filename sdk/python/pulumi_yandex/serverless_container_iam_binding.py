...
class ServerlessContainerIamBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] container_id: The [Yandex Serverless Container](https://yandex.cloud/docs/serverless-containers/) ID to apply a binding to.
...
@pulumi.type_token("yandex:index/serverlessContainerIamBinding:ServerlessContainerIamBinding")
class ServerlessContainerIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ServerlessContainerIamBinding resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            members: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None,
            sleep_after: Optional[pulumi.Input[builtins.int]] = None) -> 'ServerlessContainerIamBinding':
        """
