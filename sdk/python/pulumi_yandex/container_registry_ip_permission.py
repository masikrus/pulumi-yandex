...
class ContainerRegistryIpPermissionArgs:
    def __init__(__self__, *,
                 ...
                 pulls: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 pushes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a ContainerRegistryIpPermission resource.
        :param pulumi.Input[builtins.str] registry_id: The ID of the registry that ip restrictions applied to.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] pulls: List of configured CIDRs, from which `pull` is allowed.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] pushes: List of configured CIDRs, from which `push` is allowed.
        """
    ...
    @property
    @pulumi.getter
    def pulls(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @pulls.setter
    def pulls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "pulls", value)

    @property
    @pulumi.getter
    def pushes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @pushes.setter
    def pushes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ContainerRegistryIpPermission(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ContainerRegistryIpPermission resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            pulls: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            pushes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            registry_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ContainerRegistryIpPermission':
        """
    ...
    @property
    @pulumi.getter
    def pulls(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of configured CIDRs, from which `pull` is allowed.
        """
        return pulumi.get(self, "pulls")
    ...
    @property
    @pulumi.getter
    def pushes(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of configured CIDRs, from which `push` is allowed.
        """
        return pulumi.get(self, "pushes")
