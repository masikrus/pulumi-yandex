...
namespace Pulumi.Yandex.Outputs
{
    ...
    [OutputType]
    public sealed class GetMdbMongodbClusterClusterConfigMongocfgNetResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetMdbMongodbClusterClusterConfigMongocfgNetResult(int? maxIncomingConnections)
        {
