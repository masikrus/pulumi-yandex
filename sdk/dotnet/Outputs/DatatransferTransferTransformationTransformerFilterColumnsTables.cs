...
namespace Pulumi.Yandex.Outputs
{
    ...
    [OutputType]
    public sealed class DatatransferTransferTransformationTransformerFilterColumnsTables
    {
        public readonly ImmutableArray<string> ExcludeTables;
        public readonly ImmutableArray<string> IncludeTables;

        [OutputConstructor]
        private DatatransferTransferTransformationTransformerFilterColumnsTables(
