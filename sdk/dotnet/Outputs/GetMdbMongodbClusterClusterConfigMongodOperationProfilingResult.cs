...
namespace Pulumi.Yandex.Outputs
{
    ...
    [OutputType]
    public sealed class GetMdbMongodbClusterClusterConfigMongodOperationProfilingResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly double? SlowOpSampleRate;
        /// <summary>
        ...
        [OutputConstructor]
        private GetMdbMongodbClusterClusterConfigMongodOperationProfilingResult(
            string? mode,

            double? slowOpSampleRate,

            int? slowOpThreshold)
        {
            Mode = mode;
            SlowOpSampleRate = slowOpSampleRate;
