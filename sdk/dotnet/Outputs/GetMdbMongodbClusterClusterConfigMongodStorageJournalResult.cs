...
namespace Pulumi.Yandex.Outputs
{
    ...
    [OutputType]
    public sealed class GetMdbMongodbClusterClusterConfigMongodStorageJournalResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetMdbMongodbClusterClusterConfigMongodStorageJournalResult(int? commitInterval)
        {
