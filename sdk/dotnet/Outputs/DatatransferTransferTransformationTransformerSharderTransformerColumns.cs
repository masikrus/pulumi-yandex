...
namespace Pulumi.Yandex.Outputs
{
    ...
    [OutputType]
    public sealed class DatatransferTransferTransformationTransformerSharderTransformerColumns
    {
        public readonly ImmutableArray<string> ExcludeColumns;
        public readonly ImmutableArray<string> IncludeColumns;

        [OutputConstructor]
        private DatatransferTransferTransformationTransformerSharderTransformerColumns(
