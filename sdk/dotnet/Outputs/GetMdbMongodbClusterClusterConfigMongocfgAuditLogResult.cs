...
namespace Pulumi.Yandex.Outputs
{
    ...
    [OutputType]
    public sealed class GetMdbMongodbClusterClusterConfigMongocfgAuditLogResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetMdbMongodbClusterClusterConfigMongocfgAuditLogResult(string? filter)
        {
            Filter = filter;
        }
    }
