...
namespace Pulumi.Yandex.Outputs
{
    ...
    [OutputType]
    public sealed class DatatransferTransferTransformationTransformerFilterRowsTables
    {
        public readonly ImmutableArray<string> ExcludeTables;
        public readonly ImmutableArray<string> IncludeTables;

        [OutputConstructor]
        private DatatransferTransferTransformationTransformerFilterRowsTables(
