...
namespace Pulumi.Yandex.Outputs
{
    ...
    [OutputType]
    public sealed class DatatransferTransferTransformationTransformerSharderTransformerTables
    {
        public readonly ImmutableArray<string> ExcludeTables;
        public readonly ImmutableArray<string> IncludeTables;

        [OutputConstructor]
        private DatatransferTransferTransformationTransformerSharderTransformerTables(
