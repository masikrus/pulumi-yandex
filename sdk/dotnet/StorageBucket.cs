...
namespace Pulumi.Yandex
{
    ...
    public partial class StorageBucket : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("disabledStatickeyAuth")]
        public Output<bool?> DisabledStatickeyAuth { get; private set; } = null!;
    ...
    public sealed class StorageBucketArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// If true, static key authentication in bucket is forbidden. Default is `False`.
        /// </summary>
        [Input("disabledStatickeyAuth")]
        public Input<bool>? DisabledStatickeyAuth { get; set; }
        ...
        /// &gt; To manage `Grant` argument, service account with `storage.admin` role should be used.
        /// </summary>
        [Obsolete(@"Use `YandexStorageBucketGrant` instead.")]
