...
namespace Pulumi.Yandex.Inputs
{
    ...
    public sealed class MdbMongodbClusterClusterConfigMongodGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("net")]
        public Input<Inputs.MdbMongodbClusterClusterConfigMongodNetGetArgs>? Net { get; set; }
        ...
        public Input<Inputs.MdbMongodbClusterClusterConfigMongodOperationProfilingGetArgs>? OperationProfiling { get; set; }

        /// <summary>
        /// A set of oplog settings (see the [oplog](https://www.mongodb.com/docs/manual/core/replica-set-oplog) option).
        /// </summary>
        [Input("oplog")]
        public Input<Inputs.MdbMongodbClusterClusterConfigMongodOplogGetArgs>? Oplog { get; set; }
        ...
        /// </summary>
        [Input("storage")]
        public Input<Inputs.MdbMongodbClusterClusterConfigMongodStorageGetArgs>? Storage { get; set; }
