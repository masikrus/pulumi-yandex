...
namespace Pulumi.Yandex.Inputs
{
    ...
    public sealed class CdnResourceOptionsArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Obsolete(@"This attribute does not affect anything. You can safely delete it.")]
        ...
        /// </summary>
        [Input("edgeCacheSettingsCodes")]
        public Input<Inputs.CdnResourceOptionsEdgeCacheSettingsCodesArgs>? EdgeCacheSettingsCodes { get; set; }

        /// <summary>
        /// Enable access limiting by IP addresses, option available only with setting secure_key.
        /// </summary>
        [Input("enableIpUrlSigning")]
        public Input<bool>? EnableIpUrlSigning { get; set; }
        ...
        /// </summary>
        [Input("ipAddressAcl")]
        public Input<Inputs.CdnResourceOptionsIpAddressAclArgs>? IpAddressAcl { get; set; }
        ...
        /// </summary>
        [Input("rewriteFlag")]
        public Input<string>? RewriteFlag { get; set; }
        ...
        /// </summary>
        [Input("rewritePattern")]
        public Input<string>? RewritePattern { get; set; }

        /// <summary>
        /// Set secure key for url encoding to protect contect and limit access by IP addresses and time limits.
        /// </summary>
        [Input("secureKey")]
        public Input<string>? SecureKey { get; set; }
        ...
        [Input("stales")]
        private InputList<string>? _stales;
        ...
        /// </summary>
        public InputList<string> Stales
        {
            get => _stales ?? (_stales = new InputList<string>());
            set => _stales = value;
        }
        ...
        public static new CdnResourceOptionsArgs Empty => new CdnResourceOptionsArgs();
    }
}
