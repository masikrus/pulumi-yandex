...
namespace Pulumi.Yandex.Inputs
{
    ...
    public sealed class AlbVirtualHostRouteHttpRouteHttpRouteActionGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("rateLimit")]
        public Input<Inputs.AlbVirtualHostRouteHttpRouteHttpRouteActionRateLimitGetArgs>? RateLimit { get; set; }

        /// <summary>
        /// Replacement for path substrings that match the pattern
        /// </summary>
        [Input("regexRewrite")]
        public Input<Inputs.AlbVirtualHostRouteHttpRouteHttpRouteActionRegexRewriteGetArgs>? RegexRewrite { get; set; }
