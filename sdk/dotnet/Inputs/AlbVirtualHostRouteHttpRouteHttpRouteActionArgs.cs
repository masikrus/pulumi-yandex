...
namespace Pulumi.Yandex.Inputs
{
    ...
    public sealed class AlbVirtualHostRouteHttpRouteHttpRouteActionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("rateLimit")]
        public Input<Inputs.AlbVirtualHostRouteHttpRouteHttpRouteActionRateLimitArgs>? RateLimit { get; set; }

        /// <summary>
        /// Replacement for path substrings that match the pattern
        /// </summary>
        [Input("regexRewrite")]
        public Input<Inputs.AlbVirtualHostRouteHttpRouteHttpRouteActionRegexRewriteArgs>? RegexRewrite { get; set; }
