...
namespace Pulumi.Yandex.Inputs
{
    ...
    public sealed class SwsSecurityProfileSecurityRuleWafGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("condition")]
        public Input<Inputs.SwsSecurityProfileSecurityRuleWafConditionGetArgs>? Condition { get; set; }
        ...
        /// </summary>
        [Input("wafProfileId", required: true)]
        public Input<string> WafProfileId { get; set; } = null!;

        public SwsSecurityProfileSecurityRuleWafGetArgs()
        {
        }
        public static new SwsSecurityProfileSecurityRuleWafGetArgs Empty => new SwsSecurityProfileSecurityRuleWafGetArgs();
    }
}
